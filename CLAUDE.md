<!-- Generated from harness/github-copilot/instructions/copilot-repository-governance.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Applies repository-wide source-of-truth, freshness, synchronization, and validation rules for Copilot and generated Claude Code primitives. Use for every change in this repository.
