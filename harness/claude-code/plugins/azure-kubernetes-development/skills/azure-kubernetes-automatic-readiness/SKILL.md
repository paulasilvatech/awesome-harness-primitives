...
description: >-
  Assess Kubernetes workloads and cluster configuration for AKS Automatic compatibility, identify
  incompatibilities, generate fixes, and guide migration from AKS Standard to AKS Automatic. Use
  when the user wants to migrate to AKS Automatic, check AKS Automatic readiness, validate
  manifests for Automatic, assess a cluster for Automatic compatibility, fix a deployment for
  Automatic, or identify AKS Automatic migration blockers.
license: MIT
metadata:
  author: Microsoft
  version: 1.0.1
...
<!-- Generated from harness/github-copilot/plugins/azure-kubernetes-development/skills/azure-kubernetes-automatic-readiness/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
...
```markdown
## AKS Automatic readiness result

**Status:** ready | blockers-found | blocked
**Summary:** <one sentence covering scope and outcome>

### Details
Incompatibilities found, generated fixes, and migration steps.
...
- [ ] Each blocker names the manifest or setting that caused it.
- [ ] Proposed fixes were validated against AKS Automatic constraints.
