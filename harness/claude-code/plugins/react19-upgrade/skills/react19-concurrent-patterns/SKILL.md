...
description: >-
  Preserve React 18 concurrent patterns and adopt React 19 APIs including useTransition,
  useDeferredValue, Suspense, use(), useOptimistic, useActionState, useFormStatus, and Actions.
  Use when reviewing React 19 migrations, auditing concurrent rendering, cleaning up Suspense data
  fetching, or adopting post-migration APIs.
---

<!-- Generated from harness/github-copilot/plugins/react19-upgrade/skills/react19-concurrent-patterns/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
