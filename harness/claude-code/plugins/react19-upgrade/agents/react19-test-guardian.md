...
description: >-
  Test suite fixer and verification specialist. Use when react19-commander needs a hidden subagent
  to migrate all tests to React 19 compatibility and keep fixing until npm test reports zero
  failures.
tools: Read, Grep, Glob, Edit, Write, Bash
---

<!-- Generated from harness/github-copilot/plugins/react19-upgrade/agents/react19-test-guardian.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
...
| `Simulate` | `fireEvent` from `@testing-harness/github-copilot/react` |
| `renderIntoDocument` | `render` from `@testing-harness/github-copilot/react` |
