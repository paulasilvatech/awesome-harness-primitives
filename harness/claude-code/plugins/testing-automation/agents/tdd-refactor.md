...
name: tdd-refactor
description: >-
  Improve code quality, apply security best practices, and enhance design while keeping tests
  green. Use during the TDD refactor phase with GitHub issue acceptance criteria.
tools: Read, Grep, Glob, Edit, Write, Bash, mcp__github
---

<!-- Generated from harness/github-copilot/plugins/testing-automation/agents/tdd-refactor.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
