...
description: >-
  Generate or audit public-web metadata, canonical URLs, crawl policy, structured data, social
  previews, favicons, app icons, Web App Manifests, robots rules, and sitemaps without ranking
  guarantees. Use this skill when frontend work involves SEO, sharing previews, PWA identity, or
  public-route discoverability.
---

<!-- Generated from harness/github-copilot/plugins/frontend-experience/skills/frontend-discoverability-assets/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
