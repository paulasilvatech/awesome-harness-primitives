...
description: >-
  Validate story-to-acceptance-to-scenario-to-evidence traceability, defect severity, required
  environments, and frontend release readiness, then issue Ready, Ready with follow-ups, or
  Blocked. Use this skill when final QA evidence or a release verdict is requested.
---

<!-- Generated from harness/github-copilot/plugins/frontend-experience/skills/frontend-release-quality-gate/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
