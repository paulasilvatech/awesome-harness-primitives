...
description: >-
  ...
  evidence without mandating every layer. Use this skill when planning QA scope, Definition of
  Done, regression coverage, test data, or frontend release criteria.
---

<!-- Generated from harness/github-copilot/plugins/frontend-experience/skills/frontend-test-strategy/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
