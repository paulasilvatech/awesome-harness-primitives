...
description: >-
  Independently verify frontend acceptance criteria, runtime behavior, visual quality,
  accessibility, backend integration, and release readiness. Use after implementation when
  evidence and a defensible release verdict are required.
tools: Read, Grep, Glob, Bash, mcp__playwright
---

<!-- Generated from harness/github-copilot/plugins/frontend-experience/agents/frontend-qa-engineer.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
