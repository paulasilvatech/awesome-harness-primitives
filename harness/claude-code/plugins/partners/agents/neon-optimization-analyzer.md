...
description: >-
  Identify and fix slow Postgres queries using Neon's database branching workflow. Use for
  execution-plan analysis, isolated optimization tests, and before/after performance metrics.
tools: Read, Grep, Glob, Edit, Write
---

<!-- Generated from harness/github-copilot/plugins/partners/agents/neon-optimization-analyzer.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
