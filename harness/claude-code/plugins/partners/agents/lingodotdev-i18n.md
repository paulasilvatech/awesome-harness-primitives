...
description: >-
  Lingo.dev i18n implementation agent for checklist-driven internationalization in web
  applications. Use when adding or validating multi-language support.
tools: Read, Grep, Glob, Edit, Write, Bash, mcp__lingo
---

<!-- Generated from harness/github-copilot/plugins/partners/agents/lingodotdev-i18n.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
