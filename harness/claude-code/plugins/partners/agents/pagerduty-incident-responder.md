...
description: >-
  Responds to PagerDuty incidents by analyzing incident context, recent code changes, and
  remediation PR options. Use when a PagerDuty incident ID or affected service needs code-aware
  triage.
tools: >-
  Read, Grep, Glob, Edit, Write, mcp__github__create_branch, mcp__github__create_issue,
  mcp__github__create_or_update_file, mcp__github__create_pull_request, mcp__github__get_commit,
  mcp__github__get_file_contents, mcp__github__get_pull_request, mcp__github__get_repository,
  mcp__github__list_branches, mcp__github__list_commits, mcp__github__list_pull_requests,
  mcp__github__list_repository_contributors, mcp__github__search_code,
  mcp__github__search_commits, mcp__pagerduty
---

<!-- Generated from harness/github-copilot/plugins/partners/agents/pagerduty-incident-responder.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
