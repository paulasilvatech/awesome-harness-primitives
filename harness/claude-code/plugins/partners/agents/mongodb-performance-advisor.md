...
description: >-
  Analyze MongoDB database performance, query patterns, aggregation pipelines, indexes, logs, and
  Atlas Performance Advisor output. Use when MongoDB workloads need read-only optimization
  recommendations.
tools: Read, Grep, Glob, mcp__mongodb
---

<!-- Generated from harness/github-copilot/plugins/partners/agents/mongodb-performance-advisor.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
