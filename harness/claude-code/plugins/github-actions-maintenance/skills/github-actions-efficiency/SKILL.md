...
description: >-
  Audit GitHub Actions workflow efficiency and recommend fixes that reduce CI runtime, runner
  minutes, and wasted workflow runs. Use when the user asks about caching, concurrency, path
  filters, matrix reduction, job optimization, workflow cost, or CI baseline design.
---

<!-- Generated from harness/github-copilot/plugins/github-actions-maintenance/skills/github-actions-efficiency/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
