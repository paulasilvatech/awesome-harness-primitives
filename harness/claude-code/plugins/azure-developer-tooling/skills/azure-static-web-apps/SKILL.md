...
description: >-
  Create, configure, run, and deploy Azure Static Web Apps with the SWA CLI. Use when asked to
  deploy a static site to Azure, run SWA locally, configure staticwebapp.config.json, add Azure
  Functions APIs, set API runtimes, database connections, or GitHub Actions CI/CD for Static Web
  Apps.
---

<!-- Generated from harness/github-copilot/plugins/azure-developer-tooling/skills/azure-static-web-apps/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
