...
description: >-
  Generates production-ready Infrastructure as Code in Bicep, ARM, Terraform, or Pulumi. Use when
  users request infrastructure code, deployment templates, or IaC with Azure-first validation.
tools: >-
  Read, Grep, Glob, Edit, Write, Bash, WebFetch, WebSearch, Agent,
  mcp__azure-mcp__azureterraformbestpractices, mcp__azure-mcp__bicepschema,
  mcp__azure-mcp__search, mcp__pulumi-mcp__get-type
---

<!-- Generated from harness/github-copilot/plugins/azure-developer-tooling/agents/azure-iac-generator.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
