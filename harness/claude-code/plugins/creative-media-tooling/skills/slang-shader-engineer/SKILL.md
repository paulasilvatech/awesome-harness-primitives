...
description: >-
  Write, review, refactor, explain, and optimize Slang shaders and C++ engine integration for
  graphics pipelines, compute shaders, tessellation, ray tracing, parameter blocks, generics,
  interfaces, capabilities, autodiff, cross-compilation, and shader portability. Use when the user
  mentions Slang, .slang files, slangc, SPIR-V, HLSL, GLSL, Metal, CUDA, shader stages, or modern
  shader language features.
---

<!-- Generated from harness/github-copilot/plugins/creative-media-tooling/skills/slang-shader-engineer/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
