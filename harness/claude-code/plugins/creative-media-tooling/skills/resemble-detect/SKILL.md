...
description: >-
  Detect synthetic or manipulated audio, image, video, and text with Resemble AI; trace audio
  synthesis sources; apply or detect watermarks; verify speaker identity; and inspect media
  intelligence. Use this skill when checking deepfakes, fake detection, synthetic media,
  authenticity, provenance, AI-written text, voice verification, watermarking, source tracing, or
  whether media is real or fake.
license: Apache-2.0
metadata:
  compatibility: >-
    Requires a Resemble AI API key from https://app.resemble.ai set as RESEMBLE_API_KEY. All media
    must be accessible through public HTTPS URLs except text detection.
---

<!-- Generated from harness/github-copilot/plugins/creative-media-tooling/skills/resemble-detect/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
