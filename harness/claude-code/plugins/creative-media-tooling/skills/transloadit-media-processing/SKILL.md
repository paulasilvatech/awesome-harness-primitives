...
description: >-
  Process media files (video, audio, images, documents) using Transloadit. Use when asked to
  encode video to HLS/MP4, generate thumbnails, resize or watermark images, extract audio,
  concatenate clips, add subtitles, OCR documents, or run any media processing pipeline. Covers
  86+ processing robots for file transformation at scale.
license: MIT
metadata:
  compatibility: >-
...
<!-- Generated from harness/github-copilot/plugins/creative-media-tooling/skills/transloadit-media-processing/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
