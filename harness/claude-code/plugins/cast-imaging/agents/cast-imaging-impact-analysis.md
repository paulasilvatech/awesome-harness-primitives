...
description: >-
  Specialized agent for comprehensive change impact assessment and risk analysis in software
  systems using CAST Imaging.
tools: Read, Grep, Glob, mcp__imaging-impact-analysis
---

<!-- Generated from harness/github-copilot/plugins/cast-imaging/agents/cast-imaging-impact-analysis.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
