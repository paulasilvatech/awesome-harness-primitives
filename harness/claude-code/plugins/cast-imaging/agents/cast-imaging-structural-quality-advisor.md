...
description: >-
  Specialized agent for identifying, analyzing, and providing remediation guidance for code
  quality issues using CAST Imaging. Use for structural quality, security, Green IT, and ISO-5055
  analysis.
tools: Read, Grep, Glob, mcp__imaging-structural-quality
---

<!-- Generated from harness/github-copilot/plugins/cast-imaging/agents/cast-imaging-structural-quality-advisor.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
