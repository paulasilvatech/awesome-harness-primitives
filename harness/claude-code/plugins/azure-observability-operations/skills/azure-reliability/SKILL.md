...
description: >-
  Assess and improve the reliability posture of Azure Functions and Azure App Service workloads by
  scanning deployed resources for zone redundancy, ZRS storage, health probes, and multi-region
  failover, then driving staged remediation through CLI or infrastructure-as-code patches with
  user confirmation. Use when the user asks to assess or check reliability, review zone redundancy
  or multi-region failover, improve high availability or disaster recovery, find single points of
  failure, or evaluate resiliency posture.
license: MIT
metadata:
  author: Microsoft
  version: 1.1.1
...
<!-- Generated from harness/github-copilot/plugins/azure-observability-operations/skills/azure-reliability/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
...
**Status:** assessed | remediated | blocked
**Summary:** <one sentence covering scope and outcome>

### Details
Reliability findings by feature and the staged remediation applied.
...
- [ ] Findings reflect the live configuration of deployed resources.
- [ ] Every remediation step was confirmed by the user before execution.
