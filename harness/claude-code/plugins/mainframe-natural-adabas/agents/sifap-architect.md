...
<!-- Generated from harness/github-copilot/plugins/mainframe-natural-adabas/agents/sifap-architect.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
...
Before design, load `sifap-modernization-context`, `sifap-loop`, `sifap-requirements-traceability`,
`sifap-workshop-orchestration`, `code-modernization`, and `create-architectural-decision-record` when an
ADR is warranted.
...
| `sifap-builder` | agent | Requirements and design are approved | Bounded scope, REQ-IDs, contracts, decisions, source evidence, tests, and blockers. |
