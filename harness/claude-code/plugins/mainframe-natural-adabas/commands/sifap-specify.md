...
<!-- Generated from harness/github-copilot/plugins/mainframe-natural-adabas/prompts/sifap-specify.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
...
```text
/sifap-specify feature=001-payment-inspection rules=01-archaeology/business-rules-catalog.md
```
...
| --- | --- | --- |
| `sifap-architect` | agent | Owns requirements and architecture judgment. |
| `sifap-build-slice` | prompt | Implements the approved bounded handoff. |
