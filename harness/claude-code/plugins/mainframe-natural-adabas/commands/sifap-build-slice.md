...
<!-- Generated from harness/github-copilot/plugins/mainframe-natural-adabas/prompts/sifap-build-slice.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
...
| `sifap-verify` | prompt | Proves behavior and data equivalence for the validated slice. |
