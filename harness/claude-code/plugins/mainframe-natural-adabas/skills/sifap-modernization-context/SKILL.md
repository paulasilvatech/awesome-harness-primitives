---
name: sifap-modernization-context
description: >-
  Load the SIFAP Natural/Adabas workshop profile, source-evidence boundaries, target stack,
  traceability contract, and sensitive-data rules. Use when analyzing, specifying, designing,
  implementing, testing, or operationalizing the SIFAP modernization.
user-invocable: true
---

<!-- Generated from harness/github-copilot/plugins/mainframe-natural-adabas/skills/sifap-modernization-context/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
...
| EARS requirements and SIFAP source lineage | `sifap-requirements-traceability` |
| Workshop stages and handoffs | `sifap-workshop-orchestration` |
