---
name: sifap-infrastructure
description: >-
  Defines SIFAP IaC and Azure safety for provider baselines, identity, state, networks, plans, and
  approvals. Use when editing infrastructure, Compose, or deployment configuration.
paths:
  - infra/**
  - "**/*.tf"
  - "**/*.tfvars"
...
<!-- Generated from harness/github-copilot/plugins/mainframe-natural-adabas/instructions/sifap-infrastructure.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
