...
description: >-
  Dependency upgrade specialist for React 16/17 to exact React 18.3.1. Use inside React migration
  pipelines to pin React, upgrade compatible libraries, detect Enzyme blockers, and return
  GO/NO-GO evidence.
tools: Read, Grep, Glob, Edit, Write, Bash, WebFetch, WebSearch
---

<!-- Generated from harness/github-copilot/plugins/react18-upgrade/agents/react18-dep-surgeon.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
...
5. **Upgrade RTL.** Move `@testing-harness/github-copilot/react` to v14+, `@testing-harness/github-copilot/jest-dom` to v6+, and `@testing-harness/github-copilot/user-event` to v14+.
...
```bash
npm install --save-dev   @testing-harness/github-copilot/react@^14.0.0   @testing-harness/github-copilot/jest-dom@^6.0.0   @testing-harness/github-copilot/user-event@^14.0.0
...
| `@testing-harness/github-copilot/react` is below v14 | NO-GO; v13 and below use `ReactDOM.render` internally. |
...
- `react`: <version>
- `react-dom`: <version>
- `@testing-harness/github-copilot/react`: <version>
...
- [ ] `@testing-harness/github-copilot/react@14.x` or newer is installed when RTL is present.
