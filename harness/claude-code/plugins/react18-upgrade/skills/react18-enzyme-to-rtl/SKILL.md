...
description: >-
  ...
  wrapper.state(), wrapper.instance(), Enzyme configure/Adapter, or needs React 18-compatible RTL
  migration patterns.
---

<!-- Generated from harness/github-copilot/plugins/react18-upgrade/skills/react18-enzyme-to-rtl/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
