...
name: qdrant-scaling
description: >-
  Guide Qdrant scaling decisions for data volume, query throughput, query latency, query volume,
  tenant growth, sharding, and capacity planning. Use when someone asks how many nodes are needed,
  whether to scale vertically or horizontally, why a cluster is slow, how to shard, or how to add
  capacity.
allowed-tools: Read, Grep, Glob
---

<!-- Generated from harness/github-copilot/plugins/qdrant-development/skills/qdrant-scaling/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
