...
description: >-
  ...
  generating findings and GitHub issues for improvements. Use this skill when the user asks for
  azure well-architected review.
---

<!-- Generated from harness/github-copilot/plugins/azure-governance/skills/azure-well-architected-review/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
