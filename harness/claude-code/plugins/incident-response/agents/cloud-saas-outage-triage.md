...
description: >-
  Distinguish upstream cloud or SaaS incidents from application failures before changing code,
  using live official-feed status and incident timelines.
tools: Read, Grep, Glob, mcp__outagedeck
---

<!-- Generated from harness/github-copilot/plugins/incident-response/agents/cloud-saas-outage-triage.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
