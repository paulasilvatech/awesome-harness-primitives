...
description: >-
  Turn vague, intermittent, or environment-specific bug reports into minimal evidence-backed
  reproductions before diagnosis or repair. Use when a bug report is incomplete, mixed with an
  assumed cause, hard to reproduce, or needs observed failure, environment, expected/actual
  behavior, repeatability, and safe next hypothesis.
---

<!-- Generated from harness/github-copilot/plugins/incident-response/skills/bug-reproduction-brief/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
