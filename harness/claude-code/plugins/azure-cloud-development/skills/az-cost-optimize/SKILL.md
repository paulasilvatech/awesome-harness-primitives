...
description: >-
  Analyze Azure IaC files and deployed Azure resources for evidence-based cost optimization,
  validate current costs, calculate priority scores, and draft GitHub issues. Use when asked to
  "azure cost optimize", "reduce Azure spend", "find Azure cost savings", "right-size Azure
  resources", or "create cost optimization issues".
---

<!-- Generated from harness/github-copilot/plugins/azure-cloud-development/skills/az-cost-optimize/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
