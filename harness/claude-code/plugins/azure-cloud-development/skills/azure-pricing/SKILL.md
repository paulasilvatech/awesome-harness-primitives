...
name: azure-pricing
description: >-
  Fetch live Azure Retail Prices API data and estimate Azure service, SKU, region, reservation,
  savings plan, spot, and Copilot Studio credit costs. Use when the user asks about Azure pricing,
  Azure costs, Azure billing, workload estimates, SKU comparison, Copilot Credits, Copilot Studio
  pricing, or agent usage estimation.
metadata:
  author: anthonychu
...
<!-- Generated from harness/github-copilot/plugins/azure-cloud-development/skills/azure-pricing/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
