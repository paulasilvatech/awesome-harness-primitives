...
description: >-
  ...
  project, analyzes build errors, applies fixes, and iterates until successful compilation using
  Oracle best practices. Use this skill when the user asks for graalvm native image agent.
---

<!-- Generated from harness/github-copilot/plugins/java-kotlin-development/skills/java-add-graalvm-native-image-support/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
