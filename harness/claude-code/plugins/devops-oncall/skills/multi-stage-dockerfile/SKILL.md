...
description: >-
  Create or improve optimized multi-stage Dockerfiles with builder, dependency, test, and runtime
  stages. Use when the user asks for a multi-stage structure, smaller image, secure runtime image,
  Docker layer cache improvements, non-root container, .dockerignore, HEALTHCHECK, or Dockerfile
  best practices.
---

<!-- Generated from harness/github-copilot/plugins/devops-oncall/skills/multi-stage-dockerfile/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
