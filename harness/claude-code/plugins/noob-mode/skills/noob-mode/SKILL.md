...
name: noob-mode
description: >-
  Translate GitHub Copilot CLI approvals, command output, errors, jargon, and completion summaries
  into plain English for non-technical users. Use this skill when the user says "turn on noob
  mode", asks for jargon-free explanations, wants risk explained before actions, or needs terminal
  output translated.
---

<!-- Generated from harness/github-copilot/plugins/noob-mode/skills/noob-mode/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
