...
description: >-
  Find and explore Windows desktop APIs. Use when building features that need platform
  capabilities — camera, file access, notifications, UI controls, AI/ML, sensors, networking, etc.
  Discovers the right API for a task and retrieves full type details (methods, properties, events,
  enumeration values).
license: Complete terms in LICENSE.txt
---

<!-- Generated from harness/github-copilot/plugins/dotnet-desktop-development/skills/winmd-api-search/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
