...
description: >-
  Diagnose and improve go-to-market positioning by auditing competitor messaging, finding
  defensible differentiation, testing claims, and planning Crawl-Walk-Run rollout. Use when
  messaging sounds like competitors, conversion is weak despite awareness, sales cannot explain
  differentiation, buyers see the product as interchangeable, or a team wants to test positioning
  before rebrand.
license: MIT
metadata:
...
<!-- Generated from harness/github-copilot/plugins/go-to-market/skills/gtm-positioning-strategy/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
