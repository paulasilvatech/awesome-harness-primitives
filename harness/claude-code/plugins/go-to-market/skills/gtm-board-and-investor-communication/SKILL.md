...
description: >-
  Board meeting preparation, investor updates, and executive communication. Use when preparing
  board decks, writing investor updates, handling bad news with the board, structuring QBRs, or
  building board-level metric discipline. Includes the "Three Things" narrative model, the 4-tier
  metric hierarchy, and the pre-brief pattern that prevents board surprises.
license: MIT
metadata:
...
<!-- Generated from harness/github-copilot/plugins/go-to-market/skills/gtm-board-and-investor-communication/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
...
- "Board deck structure, or how often should we update investors?"
...
| --- | --- | --- |
| `operating-cadence` | skill | Internal meeting rhythms must feed board preparation. |
| `enterprise-account-planning` | skill | Pipeline and deal metrics are needed for board reporting. |
| `technical-product-pricing` | skill | Pricing decisions require board input. |

## Output template

```markdown
## Board and investor communication — <company or period>

**Status:** ready | needs data | blocked
**Audience:** board | investors | executive team
**Cadence:** board meeting | monthly update | ad-hoc bad-news update | QBR

### Narrative
**What's working:** <2-3 specific momentum points>
**What's not:** <1-2 specific gaps or misses>
**What we're doing about it:** <owners, actions, dates>

### Metrics
| Tier | Metric | Actual | Plan | Status | Context |
| --- | --- | --- | --- | --- | --- |
| North star | <metric> | <value> | <target> | green/yellow/red | <one sentence> |

### Decisions and asks
- <decision needed, intro requested, approval, or advice>
### Follow-up
- <owner>: <action> by <date>
```

## Quality gate
- [ ] The communication opens with narrative before data.
- [ ] The Three Things model names what is working, what is not, and what is being done about it.
- [ ] Board meetings use the pre-read + decisions + deep dive structure, not a status-report walkthrough.
- [ ] Metrics use the four-tier hierarchy and show actuals vs plan with green/yellow/red health indicators.
- [ ] Bad news includes what happened, why, impact, plan, and pre-brief status when material.
- [ ] Investor updates include TL;DR, consistent metrics, key updates, and specific asks.
- [ ] Follow-up owners and dates are explicit.
## References
