...
description: >-
  AI agent governance expert that reviews code for safety issues, missing governance controls, and
  helps implement policy enforcement, trust scoring, and audit trails in agent systems.
tools: Read, Grep, Glob, Bash
---

<!-- Generated from harness/github-copilot/plugins/agent-governance/agents/agent-governance-reviewer.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
