...
name: refactor-plan
description: >-
  Create a concrete, evidence-backed plan before a multi-file refactor. Use this skill when the
  user asks to plan, sequence, scope, or safely execute a refactor across multiple files, when
  hidden coupling is likely, or when implementation should wait for confirmation after a plan.
---

<!-- Generated from harness/github-copilot/plugins/context-engineering/skills/refactor-plan/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
