...
description: >-
  Review or improve .NET and C# code against solution/project best practices for documentation,
  architecture, dependency injection, resources, async, tests, configuration, Semantic Kernel,
  logging, performance, security, SOLID, and code quality. Use when asked for .net/c# or .NET/C#
  best practices or cleanup.
---

<!-- Generated from harness/github-copilot/plugins/csharp-dotnet-development/skills/dotnet-best-practices/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
