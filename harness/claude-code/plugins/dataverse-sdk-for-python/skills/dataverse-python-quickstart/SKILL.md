...
description: >-
  Generate concise Microsoft Dataverse SDK for Python preview setup, authentication, CRUD, bulk
  create/update, paging, and optional File column upload snippets using official patterns. Use
  when the user asks for Dataverse Python quickstart code, SDK setup,
  InteractiveBrowserCredential, retrieve-multiple paging, or basic CRUD examples.
---

<!-- Generated from harness/github-copilot/plugins/dataverse-sdk-for-python/skills/dataverse-python-quickstart/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
