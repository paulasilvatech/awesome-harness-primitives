...
description: >-
  Write and review unit tests for Vue 3 + TypeScript + Vitest + Pinia codebases. Use when creating
  or updating tests for components, composables, and stores; mocking Pinia with
  createTestingPinia; applying Vue Test Utils patterns; and enforcing black-box assertions over
  implementation details.
metadata:
  category: testing
---

<!-- Generated from harness/github-copilot/plugins/testing-frameworks/skills/unit-test-vue-pinia/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
