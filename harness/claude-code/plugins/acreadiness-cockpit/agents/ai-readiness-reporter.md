...
description: >-
  Runs an AgentRC readiness assessment and produces a self-contained static HTML dashboard at
  reports/index.html. Use when asked to assess, audit, score, report on, or visualize repository
  AI readiness.
tools: Read, Grep, Glob
---

<!-- Generated from harness/github-copilot/plugins/acreadiness-cockpit/agents/ai-readiness-reporter.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
