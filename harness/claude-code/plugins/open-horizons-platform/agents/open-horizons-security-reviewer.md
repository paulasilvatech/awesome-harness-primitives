...
description: >-
  Independently review one bounded Open Horizons change or security surface. Use for
  severity-ranked findings on code, Terraform, Kubernetes, identity, workflows, agents, tools,
  secrets, or policy.
tools: Read, Grep, Glob, Bash
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/agents/open-horizons-security-reviewer.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
