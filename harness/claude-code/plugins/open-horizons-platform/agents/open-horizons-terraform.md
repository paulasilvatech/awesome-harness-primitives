...
description: >-
  Author and validate one bounded Open Horizons Terraform change. Use for modules, live-root
  configuration, variables, providers, tests, formatting, validation, or approved plan inspection;
  never apply.
tools: Read, Grep, Glob, Edit, Write, Bash
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/agents/open-horizons-terraform.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
