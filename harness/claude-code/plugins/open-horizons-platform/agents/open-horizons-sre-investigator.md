...
description: >-
  Investigate one Open Horizons reliability symptom or incident with read-only telemetry. Use to
  establish impact, test causal hypotheses, identify ownership, and define mitigation and
  verification.
tools: Read, Grep, Glob, Bash
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/agents/open-horizons-sre-investigator.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
