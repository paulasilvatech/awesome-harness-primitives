...
description: >-
  Route cross-domain Open Horizons repository work among the final agent portfolio. Use when
  ownership is unclear, multiple domains are involved, or staged delegation and validation are
  required.
tools: Read, Grep, Glob, Agent
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/agents/open-horizons-orchestrator.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
