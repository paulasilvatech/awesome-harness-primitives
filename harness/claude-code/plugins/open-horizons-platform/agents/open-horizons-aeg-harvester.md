...
description: >-
  Turn completed Open Horizons AEG runs into evidence-backed draft stack profiles and golden-path
  proposals. Use when recurring stacks, ADRs, tests, gates, and controls should be evaluated for
  reusable Backstage templates.
tools: >-
  mcp__open-horizons-aeg__aeg_get_run, mcp__open-horizons-aeg__aeg_get_traceability,
  mcp__open-horizons-aeg__aeg_propose_profile
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/agents/open-horizons-aeg-harvester.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
