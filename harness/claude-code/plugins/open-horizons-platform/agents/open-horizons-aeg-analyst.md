...
description: >-
  Analyze Open Horizons AEG run state, traceability, metrics, cost, findings, and delivery
  evidence without mutation. Use when investigating progress, broken evidence links, loop
  behavior, gate latency, or comparable run metrics.
tools: >-
  mcp__open-horizons-aeg__aeg_get_run, mcp__open-horizons-aeg__aeg_list_runs,
  mcp__open-horizons-aeg__aeg_get_traceability, mcp__open-horizons-aeg__aeg_get_metrics
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/agents/open-horizons-aeg-analyst.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
