...
description: >-
  Assess one Open Horizons Azure deployment scope with read-only provider, quota, SKU, identity,
  network, and resource evidence. Use before planning or deployment.
tools: Read, Grep, Glob, Bash
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/agents/open-horizons-azure-readiness.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
