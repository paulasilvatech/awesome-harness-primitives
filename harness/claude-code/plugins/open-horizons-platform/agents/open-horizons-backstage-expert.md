...
description: >-
  Own generic and Open Horizons Backstage engineering judgment. Use for portal configuration,
  catalog, templates, TechDocs, plugins, authentication, permissions, integrations, upgrades,
  operations, or remediation.
tools: Read, Grep, Glob, Edit, Write, Bash, WebFetch, WebSearch
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/agents/open-horizons-backstage-expert.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
