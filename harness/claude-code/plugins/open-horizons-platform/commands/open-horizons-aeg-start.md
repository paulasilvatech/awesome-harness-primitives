...
<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/prompts/open-horizons-aeg-start.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
