...
name: backstage-app
description: >-
  Use when editing Backstage adopter-app composition, packages, dependency alignment, or
  package-owned tests.
paths:
  ...
  - backstage/plugins/ai-chat/**
user-invocable: false
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/instructions/backstage-app.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
