...
description: >-
  Use when editing Backstage Software Templates or generated skeletons that require safe, portable
  scaffolding.
paths:
  - backstage/examples/template/**
  - backstage/examples/demo-template.yaml
  - docs/aeg-feature-scaffold/backstage/**/template.yaml
  - docs/aeg-feature-scaffold/backstage/**/skeleton/**
  - scripts/golden-paths/**/skeleton/**
