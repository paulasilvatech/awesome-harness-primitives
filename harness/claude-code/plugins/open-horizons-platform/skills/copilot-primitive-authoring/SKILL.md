...
description: >-
  Requires routing, canonical paths, freshness evidence, frontmatter, tool-token, mirror, and
  validation conventions when editing Copilot primitives. Use when authoring or reviewing
  primitives, templates, or installed mirrors.
paths:
...
<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/instructions/copilot-primitive-authoring.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
