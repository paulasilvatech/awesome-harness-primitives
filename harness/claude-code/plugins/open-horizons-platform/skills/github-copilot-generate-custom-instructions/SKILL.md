...
description: >-
  Generates path-scoped GitHub Copilot migration instructions from actual branch, commit, tag, or
  release diffs. Use when handling framework upgrades, architecture refactors, technology
  migrations, dependency updates, API changes, and obsolete-pattern prevention.
argument-hint: "MIGRATION_TYPE=<type> SOURCE_REFERENCE=<ref> TARGET_REFERENCE=<ref>"
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/skills/github-copilot-generate-custom-instructions/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
