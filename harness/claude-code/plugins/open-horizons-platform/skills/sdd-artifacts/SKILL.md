...
name: sdd-artifacts
description: >-
  Use when editing tracked SDD artifacts that require naming, EARS, traceability, evidence, or
  status conventions.
paths:
  - ".specs/**/*.md"
  - ".specs/**/*.yaml"
...
<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/instructions/sdd-artifacts.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
