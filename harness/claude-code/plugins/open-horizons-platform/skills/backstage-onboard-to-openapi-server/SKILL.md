---
name: backstage-onboard-to-openapi-server
description: >-
  Migrate a Backstage backend plugin from a hand-written Express router to the repository's typed
  OpenAPI server tooling while preserving routes, auth, permissions, errors, tests, and optional
  client generation. Use when onboarding createOpenApiRouter or modernizing a router with OpenAPI.
license: Apache-2.0
metadata:
...
<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/skills/backstage-onboard-to-openapi-server/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
