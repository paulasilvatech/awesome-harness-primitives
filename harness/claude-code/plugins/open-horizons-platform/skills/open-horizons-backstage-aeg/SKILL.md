---
name: open-horizons-backstage-aeg
description: >-
  Use when editing the Open Horizons Backstage AEG feature, its proxy, actions, agent registry,
  configuration, or scaffold integration.
paths:
  - backstage/ai-kit/**
  - backstage/plugins/**/aeg/**
  - backstage/packages/backend/**/*aeg*
  - backstage/app-config*.yaml
  - docs/aeg-feature-scaffold/**
user-invocable: false
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/instructions/open-horizons-backstage-aeg.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
