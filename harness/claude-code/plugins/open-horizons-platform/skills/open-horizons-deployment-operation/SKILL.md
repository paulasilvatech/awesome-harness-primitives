...
description: >-
  Executes one approval-gated Open Horizons deployment, rollout, rollback, or verification from an
  immutable change package. Use when the exact environment, artifact, command, expected actions,
  approval, validation, and rollback are already known.
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/skills/open-horizons-deployment-operation/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
