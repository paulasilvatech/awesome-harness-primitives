...
description: >-
  Designs and provisions a Microsoft Entra agent user linked to an Agent ID identity, including
  parent validation, least-privilege permissions, optional manager, usage location, licensing, and
  verification. Use when an agent needs a user-shaped directory identity for collaboration
  workloads.
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/skills/azure-entra-agent-user/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
