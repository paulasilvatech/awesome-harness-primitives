...
name: python
description: >-
  Use when editing Python agent runtimes, FastAPI boundaries, orchestration, tools, or their
  tests.
paths:
  - backstage/server/agent-api*/*.py
  - backstage/server/agent-api*/**/*.py
  - docs/aeg-feature-scaffold/orchestrator/**/*.py
user-invocable: false
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/instructions/python.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
