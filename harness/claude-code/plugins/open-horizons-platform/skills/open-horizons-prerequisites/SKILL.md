...
description: >-
  Validates and sets up local CLI tools and access needed before Open Horizons deployment. Use
  this skill when checking required tool availability, verifying minimum versions, preparing Azure
  login readiness, validating CI/CD runner prerequisites, or producing a prerequisite checklist.
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/skills/open-horizons-prerequisites/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
