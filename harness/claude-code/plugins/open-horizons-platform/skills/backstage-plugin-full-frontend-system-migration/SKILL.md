...
description: >-
  Fully migrate a Backstage frontend plugin to the new frontend system and remove legacy support.
  Use when performing internal or intentionally breaking migrations from createPlugin to
  createFrontendPlugin, new route refs, blueprints, PageLayout, and legacy dependency removal.
license: Apache-2.0
metadata:
...
<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/skills/backstage-plugin-full-frontend-system-migration/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
