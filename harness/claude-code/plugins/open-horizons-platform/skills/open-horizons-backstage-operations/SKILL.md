---
name: open-horizons-backstage-operations
description: >-
  Operate, monitor, troubleshoot, and harden production Backstage services, databases, schedulers,
  integrations, health endpoints, logs, and deployments. Use when handling startup failures,
  readiness problems, database errors, provider refresh issues, performance incidents, or
  production runbooks.
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/skills/open-horizons-backstage-operations/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
