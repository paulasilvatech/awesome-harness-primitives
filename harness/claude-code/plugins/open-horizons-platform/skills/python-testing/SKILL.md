...
name: python-testing
description: >-
  Guidelines for writing and running tests in the Agent Framework Python codebase. Use when
  creating, modifying, or running tests.
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/skills/python-testing/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

# Python Testing

## When to invoke

- Writing or updating Agent Framework Python unit or integration tests.
- Selecting focused pytest and coverage commands for a change.
- Modifying provider integration tests or their CI jobs.
...
- Scope: `<package, files, or markers>`
- Commands: `<commands run>`
- Tests: `<passed, failed, skipped>`
- Coverage: `<result or not collected>`
- Remaining failures: `<none or details>`
```

## Quality gate

- [ ] Tests cover the changed behavior and relevant failure paths.
- [ ] Unit and integration markers follow the repository conventions.
- [ ] External-service tests skip safely when required configuration is absent.
- [ ] Related CI workflows remain synchronized when jobs change.
- [ ] Focused tests pass and required package coverage is maintained.
