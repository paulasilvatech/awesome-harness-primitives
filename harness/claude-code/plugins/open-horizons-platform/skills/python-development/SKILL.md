...
description: >-
  Coding standards, conventions, and patterns for developing Python code in the Agent Framework
  repository. Use when writing or modifying Python source files in the python/ directory.
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/skills/python-development/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

# Python Development Standards

## When to invoke

- Writing or modifying Agent Framework Python source files.
- Adding or changing public APIs, exports, connectors, or async behavior.
- Reviewing Python code against the monorepo's conventions.
...
```markdown
## Python development result

- Files changed: `<paths>`
- Public API impact: `<none or details>`
- Async and typing impact: `<summary>`
- Tests and checks: `<commands and results>`
```

## Quality gate

- [ ] Public APIs have complete types and Google-style docstrings.
- [ ] Runtime exports, `__all__`, and stubs are synchronized when applicable.
- [ ] Async paths avoid blocking work and unnecessary runtime overhead.
- [ ] Imports, naming, and formatting follow the repository conventions.
- [ ] Focused tests and quality checks passed.
