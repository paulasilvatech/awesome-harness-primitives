...
description: >-
  Guidance for package and feature lifecycle in the Agent Framework Python codebase, including
  stage meanings, feature-stage decorators, feature enums, and how to move APIs from one stage to
  the next. Use when changing API lifecycle stages or feature annotations.
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/skills/python-feature-lifecycle/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

# Python Feature Lifecycle

## When to invoke

- Assigning or reviewing Agent Framework package and feature maturity.
- Adding, changing, or removing feature-stage decorators and enums.
- Promoting an API between experimental, release candidate, released, or deprecated stages.
...
```markdown
## Feature lifecycle result

- Package stage: `<stage>`
- Feature transition: `<from> -> <to>`
- Decorators and enums changed: `<details>`
- Documentation and tests updated: `<details>`
- Validation: `<commands and results>`
```

## Quality gate

- [ ] Package maturity and feature maturity are evaluated separately.
- [ ] Decorators are used only for features behind the package default.
- [ ] Stage enums contain only currently staged features.
- [ ] Released or deprecated features no longer carry stale stage annotations.
- [ ] Tests and documentation reflect the resulting lifecycle state.
