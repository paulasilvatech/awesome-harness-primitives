...
description: >-
  Scaffold a complete, production-ready Azure project from scratch for any use case, including RAG
  chatbots, multi-agent systems, API backends, data pipelines, Azure Functions, full-stack web
  apps, ML training and inference, and event-driven microservices. Use when the user wants to
  gather requirements through adaptive questioning and generate a full project structure with
  source files, Bicep infrastructure, azure.yaml for azd, Docker configuration, CI/CD workflows, a
  README with architecture diagrams, and Responsible AI documentation targeting Azure Container
  Apps, Microsoft Foundry, Azure Functions, or Azure ML.
---

<!-- Generated from harness/github-copilot/plugins/open-horizons-platform/skills/azure-scaffold-wizard/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
...
- Scaffolding a new Azure application from an empty or new project directory.
- Gathering requirements and generating a complete deployable project.
- Producing application code, Bicep, `azure.yaml`, containers, CI/CD, observability, and documentation together.
...
```markdown
## Azure scaffold result

- Project: `<name and project type>`
- Location: `<folder>`
- Azure target: `<compute and dependent services>`
- Generated surfaces: `<application, infrastructure, CI/CD, documentation>`
...
- [ ] Universal and type-specific requirements are resolved.
- [ ] Generated source, infrastructure, deployment, and documentation surfaces are complete.
- [ ] Secrets are externalized and managed identities are used where supported.
- [ ] Images use explicit tags and generated workloads use secure defaults.
- [ ] Bicep, application checks, container configuration, and links validate.
