...
For the raw HTTP shapes and per-language SDK bindings beyond Python, web_fetch `https://platform.claude.com/docs/en/managed-agents/define-outcomes.md` (see `shared/live-sources.md`).
