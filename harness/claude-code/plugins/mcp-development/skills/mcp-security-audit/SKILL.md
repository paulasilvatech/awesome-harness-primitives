...
description: >-
  Audits MCP server configurations such as .mcp.json for hardcoded secrets, dangerous shell
  patterns, unpinned dependencies, unsafe npx usage, unapproved servers, and governance risks. Use
  this skill when asked to check MCP security, audit MCP servers, review .mcp.json, validate
  server args, detect shell injection, or verify environment-variable based credentials.
---

<!-- Generated from harness/github-copilot/plugins/mcp-development/skills/mcp-security-audit/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
