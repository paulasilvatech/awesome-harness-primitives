...
description: >-
  ...
  evidence. Use when shipping or reviewing an MCP server, tool, resource, prompt, catalog, or
  install path.
---

<!-- Generated from harness/github-copilot/plugins/mcp-development/skills/mcp-release-qa/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
