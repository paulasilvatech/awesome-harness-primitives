---
description: >-
  Map a complete COBOL/DB2 corpus into the engineering graph, then analyze one bounded scope and
  write cited inventory, dependency, rule-candidate, and open-question artifacts.
argument-hint: "corpus=01-archaeology/legacy scope=01-archaeology/legacy/<path>"
---

<!-- Generated from harness/github-copilot/plugins/mainframe-cobol-db2/prompts/cobol-db2-archaeology.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
