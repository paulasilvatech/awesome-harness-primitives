...
<!-- Generated from harness/github-copilot/plugins/mainframe-cobol-db2/prompts/cobol-db2-operate.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
...
- The `cobol-db2-context`, `cobol-db2-loop`, and `github-actions-hardening` skills are available.
...
```text
/cobol-db2-operate scope=impl/001-payment-inspection destination=05-operations/reviews/001-payment-inspection.md
```
...
| --- | --- | --- |
| `cobol-db2-operations` | agent | Owns readiness judgment and approval boundaries. |
| `cobol-db2-loop` | skill | Evaluates the operations gate and records the ledger. |
| `cobol-db2-quality` | agent | Receives behavior or data findings surfaced during release. |
