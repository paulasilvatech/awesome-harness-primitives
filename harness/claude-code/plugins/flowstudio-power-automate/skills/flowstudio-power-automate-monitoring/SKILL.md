...
description: >-
  Monitor tenant-wide Power Automate health through the FlowStudio MCP cached store. Use when
  users ask for aggregate failure rates, run-health trends, maker/app inventory, inactive owners,
  compliance/health reports, monitored flows, or tenant governance summaries. Requires FlowStudio
  for Teams or MCP Pro+.
---

<!-- Generated from harness/github-copilot/plugins/flowstudio-power-automate/skills/flowstudio-power-automate-monitoring/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
