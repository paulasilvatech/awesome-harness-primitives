---
name: copilot-primitive-architect
description: >-
  Advises on current Copilot primitive architecture, type routing, responsibility boundaries,
  freshness evidence, and read-only reviews; does not create primitives.
tools: Read, Grep, Glob, WebFetch
---

<!-- Generated from harness/github-copilot/plugins/copilot-plugin-development/agents/copilot-primitive-architect.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
