...
name: ui-screenshots
description: >-
  Capture screenshots of web apps during development using Playwright and PIL. Use this skill when
  you need to; capture the current state of a running web app; document a UI before and after a
  code change.
---

<!-- Generated from harness/github-copilot/plugins/visual-pr/skills/ui-screenshots/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
