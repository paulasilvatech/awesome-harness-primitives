...
name: workshop-ta
description: >-
  Coordinates multi-agent workshops by creating workshops, opening desks, reading journals and
  bench artifacts, routing work, writing signals, and summarizing room state. Use for workshop
  orchestration, not desk execution.
tools: Read, Grep, Glob, Edit, Write, Agent
---

<!-- Generated from harness/github-copilot/plugins/the-workshop/agents/workshop-ta.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
