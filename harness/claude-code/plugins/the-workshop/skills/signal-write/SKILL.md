...
name: signal-write
description: >-
  Emit structured agent signals as JSON files under desk .signals directories and journal markers
  for dashboard consumption. Use when a desk needs hands-up or blocked operator attention, work is
  done and ready for review, significant progress needs a checkpoint, two desks disagree, or a TA
  reports partnership coordination quality.
---

<!-- Generated from harness/github-copilot/plugins/the-workshop/skills/signal-write/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
