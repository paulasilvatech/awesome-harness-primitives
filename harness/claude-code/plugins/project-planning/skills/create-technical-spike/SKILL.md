...
description: >-
  Create time-boxed technical spike documents that answer critical implementation questions before
  development proceeds. Use this skill when the user asks to create a technical spike, research an
  API or architecture decision, document a proof of concept, evaluate performance or security
  options, or unblock development with an evidence-based recommendation.
argument-hint: spike title, category, owner, timebox, priority, and optional output folder
---

<!-- Generated from harness/github-copilot/plugins/project-planning/skills/create-technical-spike/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
