...
name: prd
description: >-
  Creates comprehensive Product Requirements Documents in Markdown with user stories, acceptance
  criteria, technical considerations, metrics, and optional GitHub issue creation after approval.
  Use when a feature needs product definition.
tools: >-
  Read, Grep, Glob, Edit, Write, WebFetch, WebSearch, mcp__github__add_issue_comment,
...
<!-- Generated from harness/github-copilot/plugins/project-planning/agents/prd.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
