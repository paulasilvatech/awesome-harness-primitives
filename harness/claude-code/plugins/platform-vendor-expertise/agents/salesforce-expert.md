...
description: >-
  ...
  integration, and Aura-to-LWC migration. Use for secure, scalable Salesforce solutions.
tools: Read, Grep, Glob, Edit, Write, Bash, WebFetch, WebSearch, Agent, mcp__sfdx-mcp
---

<!-- Generated from harness/github-copilot/plugins/platform-vendor-expertise/agents/salesforce-expert.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
