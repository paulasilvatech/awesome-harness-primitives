...
description: >-
  Analyze AWS resources used in the app (IaC files and/or resources in a target account/region)
  and optimize costs - creating GitHub issues for identified optimizations. Use this skill when
  the user asks for prerequisites.
---

<!-- Generated from harness/github-copilot/plugins/aws-cloud-development/skills/aws-cost-optimize/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
