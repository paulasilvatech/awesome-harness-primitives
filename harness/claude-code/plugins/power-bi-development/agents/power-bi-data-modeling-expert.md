...
description: >-
  Expert Power BI data modeling agent for star schema design, relationship strategy, storage-mode
  decisions, RLS, and model performance. Use when a Power BI semantic model needs
  Microsoft-aligned modeling guidance or review.
tools: Read, Grep, Glob, Edit, Write, Bash, WebFetch, WebSearch
---

<!-- Generated from harness/github-copilot/plugins/power-bi-development/agents/power-bi-data-modeling-expert.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
