...
description: >-
  Perform janitorial tasks on C#/.NET code. Use for cleanup, modernization, performance tuning,
  test coverage, documentation, and tech debt remediation.
tools: Read, Grep, Glob, Edit, Write, Bash, WebFetch, WebSearch, mcp__github
---

<!-- Generated from harness/github-copilot/plugins/code-quality-refactoring/agents/csharp-dotnet-janitor.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
