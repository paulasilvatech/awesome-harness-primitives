...
description: >-
  Run Ruff checks with optional scope and rule overrides, apply safe and unsafe autofixes
  iteratively, review each change, and resolve remaining findings with targeted edits or user
  decisions. Use this skill when the user asks for inputs.
---

<!-- Generated from harness/github-copilot/plugins/code-quality-refactoring/skills/ruff-recursive-fix/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
