...
description: >-
  Generates D2 entity-relationship diagrams from Entity Framework Core models by extracting
  DbContext, DbSet<T>, entity configuration, migrations, keys, foreign keys, owned types,
  many-to-many joins, indexes, schemas, and technical tables. Use this skill when asked to
  generate a database diagram, ERD, .d2 file, SVG, or PNG from an EF Core or ASP.NET Core
  codebase.
---

<!-- Generated from harness/github-copilot/plugins/diagram-authoring/skills/efcore-d2-db-diagram/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
