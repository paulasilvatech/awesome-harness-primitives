...
description: >-
  Generate a complete Kotlin Model Context Protocol server project using
  io.modelcontextprotocol:kotlin-sdk, Gradle, stdio or Ktor transport, typed tools, configuration,
  tests, and README documentation. Use when asked to create a Kotlin MCP server, scaffold MCP
  tools, build a Gradle MCP project, or generate a production-ready MCP server template.
---

<!-- Generated from harness/github-copilot/plugins/kotlin-mcp-development/skills/kotlin-mcp-server-generator/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
