...
name: steno-mode
description: >-
  Compress responses with disciplined expert shorthand while preserving exact technical literals,
  code, commands, paths, identifiers, versions, flags, and quoted errors. Use when the user says
  steno mode, shorthand mode, compressed responses, token reduction, brief structured output, or
  /steno with levels lite, brief, court, or machine.
license: MIT
---

<!-- Generated from harness/github-copilot/plugins/copilot-customization-authoring/skills/steno-mode/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
