...
description: >-
  Design and create GitHub Copilot custom agents with scoped tools, frontmatter, handoffs, and
  clear behavior. Use when a user wants a new or improved agent.
tools: Read, Grep, Glob, Edit, Write, Bash, WebFetch, WebSearch, Agent, mcp__github
---

<!-- Generated from harness/github-copilot/plugins/copilot-customization-authoring/agents/custom-agent-foundry.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
