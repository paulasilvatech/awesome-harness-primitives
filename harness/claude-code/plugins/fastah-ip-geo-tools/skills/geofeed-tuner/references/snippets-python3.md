...
- Use Python 3's built-in [`ipaddress` package](https://docs.python.org/3/harness/github-copilot/ipaddress.html), with `strict=True` passed to constructors where available.
...
- Use the [convenience factory functions in `ipaddress`](https://docs.python.org/3/harness/github-copilot/ipaddress.html#convenience-factory-functions).
...
- Use the strict-form parser [`ipaddress.ip_network(address, strict=True)`](https://docs.python.org/3/harness/github-copilot/ipaddress.html#ipaddress.ip_network).
