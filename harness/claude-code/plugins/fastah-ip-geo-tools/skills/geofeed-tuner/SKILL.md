...
name: geofeed-tuner
description: >-
  Create, tune, validate, and publish RFC 8805 self-published IP geolocation CSV feeds for public
  IP space. Use when asked about "IP geolocation feeds", "RFC 8805", "geofeed CSV", "tune geofeed
  accuracy", "validate a geofeed", or "publish a self-published IP geolocation feed".
license: Apache-2.0
metadata:
...
<!-- Generated from harness/github-copilot/plugins/fastah-ip-geo-tools/skills/geofeed-tuner/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
