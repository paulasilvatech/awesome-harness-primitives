---
description: >-
  Implement and validate a focused Backstage change after detecting repository mode, version,
  frontend compatibility, and approval-gated effects.
...
<!-- Generated from harness/github-copilot/plugins/backstage-expert/prompts/backstage-change.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
