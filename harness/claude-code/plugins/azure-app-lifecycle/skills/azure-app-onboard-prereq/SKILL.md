...
description: >-
  Assess whether source code is ready to deploy to Azure before any infrastructure work,
  evaluating build health, app completeness, dependencies and local services, stack compatibility,
  and deployment feasibility. Use when the user asks to evaluate a repository, check whether an
  app is ready or deployable to Azure, find deployment blockers, confirm dependency compatibility,
  ask whether Azure supports a framework, check whether a Dockerfile is needed, or determine what
...
<!-- Generated from harness/github-copilot/plugins/azure-app-lifecycle/skills/azure-app-onboard-prereq/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
...
- "Evaluate my repo before we build infrastructure."
- "What is blocking my deployment?"
- "Are my dependencies compatible with Azure?"
...
```markdown
## Prerequisite assessment result

**Status:** pass | warn | fail
**Summary:** <one sentence covering scope and outcome>

### Details
Per-component verdicts with build health, dependencies, and deployment blockers.
...
- [ ] Every component received an explicit PASS, WARN, or FAIL verdict.
- [ ] `prereq-output.json` was written and matches the documented schema.
