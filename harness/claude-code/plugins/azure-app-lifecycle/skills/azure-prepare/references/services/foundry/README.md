...
> **💡 For detailed AI guidance**, invoke the **`microsoft-agent-framework`** skill. It provides model catalog access, RAG patterns, agent creation, and evaluation workflows.
