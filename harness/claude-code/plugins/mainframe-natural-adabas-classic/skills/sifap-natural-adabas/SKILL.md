---
name: sifap-natural-adabas
description: >-
  Protects SIFAP Natural/Adabas source as evidence and requires dependency-complete, cited
  analysis. Use when reading legacy members, DDMs, FDTs, maps, copycodes, or JCL.
paths:
...
<!-- Generated from harness/github-copilot/plugins/mainframe-natural-adabas-classic/instructions/sifap-natural-adabas.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
