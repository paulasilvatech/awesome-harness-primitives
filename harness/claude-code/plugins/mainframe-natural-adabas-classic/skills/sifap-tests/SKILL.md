...
name: sifap-tests
description: >-
  Requires SIFAP tests to prove requirement and legacy-behavior coverage with deterministic,
  privacy-safe fixtures. Use when editing backend, frontend, integration, or equivalence tests.
paths:
  - backend/src/test/**
  - frontend/**/*.test.*
  - frontend/**/*.spec.*
...
<!-- Generated from harness/github-copilot/plugins/mainframe-natural-adabas-classic/instructions/sifap-tests.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
