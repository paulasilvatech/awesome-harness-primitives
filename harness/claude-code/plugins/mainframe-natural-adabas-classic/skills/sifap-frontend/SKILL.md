...
name: sifap-frontend
description: >-
  Defines the SIFAP Next.js 15, React 19, strict TypeScript, accessibility, session, and
  sensitive-data UI baseline. Use when editing frontend application source.
paths:
  - frontend/**/*.ts
  - frontend/**/*.tsx
  - frontend/**/*.css
...
<!-- Generated from harness/github-copilot/plugins/mainframe-natural-adabas-classic/instructions/sifap-frontend.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
