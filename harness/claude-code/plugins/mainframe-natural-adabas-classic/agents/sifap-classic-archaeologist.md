---
name: sifap-classic-archaeologist
description: >-
...
<!-- Generated from harness/github-copilot/plugins/mainframe-natural-adabas-classic/agents/sifap-classic-archaeologist.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
...
Before analysis, load `sifap-classic-context`, `natural-adabas-analysis`, and
...
5. Prepare a minimal handoff for `sifap-classic-architect`.
...
| --- | --- | --- | --- |
| `sifap-classic-architect` | agent | Stage 1 evidence is ready for requirements and design | Scope, evidence paths, approved candidates, contradictions, questions, and validation. |
