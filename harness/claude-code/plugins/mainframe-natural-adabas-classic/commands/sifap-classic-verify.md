---
description: >-
  Prove behavior and data equivalence for one implemented SIFAP slice with requirement coverage,
  migration mapping review, and recorded reconciliation numbers.
argument-hint: "scope=<implemented-slice> destination=response|<report-file>"
---

<!-- Generated from harness/github-copilot/plugins/mainframe-natural-adabas-classic/prompts/sifap-classic-verify.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

# /sifap-classic-verify
...
- Load SIFAP context, traceability, characterization testing, and Adabas-to-PostgreSQL migration Skills.
...
- [ ] Required SIFAP, traceability, characterization, and migration Skills were loaded.
...
2. **Load context.** Load SIFAP context and the verification and migration Skills.
...
```text
/sifap-classic-verify scope=impl/001-payment-inspection destination=04-evolution/reports/001-payment-inspection.md
```
...
| --- | --- | --- |
| `sifap-classic-quality` | agent | Owns the quality-gate verdict and routing decisions. |
| `adabas-postgresql-migration` | skill | Supplies the mapping rules and reconciliation procedure. |
| `sifap-classic-traceability` | skill | Checks requirement lineage for the verified slice. |
