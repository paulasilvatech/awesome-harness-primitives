...
description: >-
  Tracks and analyzes VS Code Insiders accessibility improvements. Use when investigating released
  accessibility fixes, issues, and feature history.
tools: Read, Grep, Glob, mcp__github__issue_read, mcp__github__search_issues
---

<!-- Generated from harness/github-copilot/plugins/accessibility-compliance/agents/insiders-a11y-tracker.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
