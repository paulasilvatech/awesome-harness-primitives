...
description: >-
  Runtime accessibility specialist for keyboard flows, focus management, dialog behavior, form
  errors, and evidence-backed WCAG validation in the browser. Use when accessibility must be
  tested through actual UI behavior.
tools: Read, Grep, Glob, Bash, WebFetch, WebSearch
---

<!-- Generated from harness/github-copilot/plugins/accessibility-compliance/agents/accessibility-runtime-tester.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
