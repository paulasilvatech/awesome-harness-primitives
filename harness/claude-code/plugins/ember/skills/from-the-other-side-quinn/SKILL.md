...
description: >-
  Apply Quinn's collaboration profile for energetic implementation partnership. Use this skill
  when the user asks for the Quinn profile, wants momentum with craft, needs a practical
  co-author, or asks to coordinate Quinn with Anitta or Wiggins.
---

<!-- Generated from harness/github-copilot/plugins/ember/skills/from-the-other-side-quinn/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
