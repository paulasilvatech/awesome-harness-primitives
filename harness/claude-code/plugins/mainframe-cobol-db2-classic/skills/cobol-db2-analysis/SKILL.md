...
description: >-
  Analyze COBOL programs, copybooks, PERFORM and CALL structure, file and VSAM access, embedded
  EXEC SQL and EXEC CICS, DB2 DDL, DCLGEN structures, cursors, and JCL job steps with source
  citations. Use when reading or inventorying a COBOL/DB2 legacy system before modernization.
---

<!-- Generated from harness/github-copilot/plugins/mainframe-cobol-db2-classic/skills/cobol-db2-analysis/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
