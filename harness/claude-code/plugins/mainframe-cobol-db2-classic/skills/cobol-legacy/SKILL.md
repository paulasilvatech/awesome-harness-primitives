...
name: cobol-legacy
description: >-
  Applies COBOL, copybook, and JCL reading conventions for evidence, precision, occurrence
  semantics, and legacy immutability. Use when inspecting or citing COBOL/DB2 legacy source.
paths:
  - "**/*.cbl"
  - "**/*.cob"
  - "**/*.CBL"
...
<!-- Generated from harness/github-copilot/plugins/mainframe-cobol-db2-classic/instructions/cobol-legacy.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
