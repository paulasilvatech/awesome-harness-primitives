...
name: db2-schema
description: >-
  Applies DB2 DDL, DCLGEN, cursor, and migration-script conventions for precision, nullability,
  access paths, and reconciliation evidence. Use when reading or writing DB2 schema and migration
  artifacts.
paths:
  - "**/*.ddl"
  - "**/*.sql"
...
<!-- Generated from harness/github-copilot/plugins/mainframe-cobol-db2-classic/instructions/db2-schema.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
