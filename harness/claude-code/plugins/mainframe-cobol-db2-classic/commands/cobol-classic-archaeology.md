---
description: >-
  Analyze one bounded COBOL/DB2 scope and write cited inventory, dependency, rule-candidate, and
  open-question artifacts.
argument-hint: "scope=01-archaeology/legacy/<path>"
---

<!-- Generated from harness/github-copilot/plugins/mainframe-cobol-db2-classic/prompts/cobol-classic-archaeology.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
