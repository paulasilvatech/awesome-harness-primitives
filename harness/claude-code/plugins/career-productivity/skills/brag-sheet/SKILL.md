...
name: brag-sheet
description: >-
  Turn vague work-history prompts into evidence-backed impact statements for performance reviews,
  self-reviews, promotion packets, weekly updates, status reports, and accomplishments. Use when
  the user says "brag", "what did I do", "backfill my work history", "review prep", "what did I
  ship", "track my wins", or documenting engineering impact from Copilot CLI sessions, git
  commits, and GitHub PRs.
argument-hint: >-
  Optional: time range ("last 2 weeks", "this half"), category ("infrastructure"), "backfill", or
  "review prep"
license: MIT
metadata:
  compatibility: >-
    Cross-platform (Windows, macOS, Linux). Works with any GitHub Copilot CLI session. Optional:
    git, gh CLI.
  version: 1.1
---

<!-- Generated from harness/github-copilot/plugins/career-productivity/skills/brag-sheet/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
