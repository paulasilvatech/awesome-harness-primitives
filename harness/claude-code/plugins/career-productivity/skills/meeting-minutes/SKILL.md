...
description: >-
  Generate concise, actionable meeting minutes for short internal meetings from notes,
  transcripts, recordings, or agendas. Use this skill when the user asks for minutes for syncs,
  standups, design reviews, triage, planning, ad-hoc meetings, decisions, action items, or
  follow-ups.
---

<!-- Generated from harness/github-copilot/plugins/career-productivity/skills/meeting-minutes/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
