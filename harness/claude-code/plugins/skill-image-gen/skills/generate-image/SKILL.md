...
name: generate-image
description: >-
  Generate AI images and visual assets through OpenAI gpt-image-2 or Google Gemini image models.
  Use when the user asks to generate, create, or make images, textures, icons, sprites, artwork,
  mockups, product visuals, or batch image assets from a text description.
...
<!-- Generated from harness/github-copilot/plugins/skill-image-gen/skills/generate-image/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
