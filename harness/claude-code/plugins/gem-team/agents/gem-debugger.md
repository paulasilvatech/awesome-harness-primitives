...
name: gem-debugger
description: >-
  Root-cause analysis agent for stack trace diagnosis, regression bisection, error reproduction,
  and structured debugging. Use as a read-only subagent when error context must be diagnosed
  before fixes.
tools: Read, Grep, Glob, Bash
---

<!-- Generated from harness/github-copilot/plugins/gem-team/agents/gem-debugger.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
