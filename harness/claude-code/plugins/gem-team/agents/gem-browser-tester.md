...
description: >-
  E2E browser testing, UI/UX validation, visual regression. Use when task acceptance criteria
  require browser-flow verification.
tools: Read, Grep, Glob, Edit, Write, Bash, mcp__playwright
---

<!-- Generated from harness/github-copilot/plugins/gem-team/agents/gem-browser-tester.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
