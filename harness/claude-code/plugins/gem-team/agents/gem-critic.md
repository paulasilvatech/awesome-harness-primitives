...
name: gem-critic
description: >-
  Challenges assumptions, finds edge cases, spots over-engineering and logic gaps. Use as a
  non-user-invocable critique agent before planning or implementation.
tools: Read, Grep, Glob
---

<!-- Generated from harness/github-copilot/plugins/gem-team/agents/gem-critic.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
