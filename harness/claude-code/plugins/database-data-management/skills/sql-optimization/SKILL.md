...
description: >-
  Universal SQL performance optimization assistant for query tuning, execution-plan review, index
  strategy, pagination, batching, aggregation, and monitoring across MySQL, PostgreSQL, SQL
  Server, Oracle, and other SQL databases. Use this skill when the user asks to optimize slow SQL,
  review query plans, improve indexes, fix SELECT performance, reduce N+1 queries, tune
  pagination, or analyze database performance.
---

<!-- Generated from harness/github-copilot/plugins/database-data-management/skills/sql-optimization/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
