...
name: java-docs
description: >-
  Write and review Java Javadoc comments for public, protected, generic, deprecated, and complex
  members. Use this skill when the user asks for Java documentation, Javadoc best practices,
  missing comments, API docs, or documentation cleanup in Java code.
---

<!-- Generated from harness/github-copilot/plugins/java-development/skills/java-docs/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
