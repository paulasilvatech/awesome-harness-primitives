...
name: qa-subagent
description: >-
  Meticulous QA subagent for test planning, bug hunting, edge-case analysis, and implementation
  verification. Use when software needs risk-based testing or bug reports.
tools: Read, Grep, Glob, WebFetch, WebSearch, Agent
---

<!-- Generated from harness/github-copilot/plugins/rug-agentic-workflow/agents/qa-subagent.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
