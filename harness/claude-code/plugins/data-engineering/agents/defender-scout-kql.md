...
description: >-
  Generates, validates, optimizes, and explains Microsoft Defender XDR Advanced Hunting KQL. Use
  for Endpoint, Identity, Office 365, Cloud Apps, alerts, email, and vulnerability queries.
tools: Read, Grep, Glob
---

<!-- Generated from harness/github-copilot/plugins/data-engineering/agents/defender-scout-kql.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
