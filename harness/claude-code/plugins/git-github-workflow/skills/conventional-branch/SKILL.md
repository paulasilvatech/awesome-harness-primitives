...
description: >-
  Create, normalize, validate, and check out Git branches following the Conventional Branch
  specification with feature/, bugfix/, hotfix/, release/, and chore/ prefixes. Use when creating
  a new branch, naming a branch, or checking branch-name compliance.
---

<!-- Generated from harness/github-copilot/plugins/git-github-workflow/skills/conventional-branch/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
