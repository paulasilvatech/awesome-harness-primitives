...
name: github-release
description: >-
  Run an end-to-end GitHub library release workflow with git and gh: inspect tags, classify public
  API changes, choose a SemVer bump, update CHANGELOG.md, create release/vX.Y.Z, push, and open a
  release PR. Use when asked to cut a release, bump a version, generate a changelog, create a
  release branch, or publish a new GitHub repository version.
metadata:
  compatibility: "requires: gh CLI and git"
---

<!-- Generated from harness/github-copilot/plugins/git-github-workflow/skills/github-release/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
