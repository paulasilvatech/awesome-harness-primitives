...
name: repo-architect
description: >-
  Bootstraps and validates agentic project structures for GitHub Copilot (VS Code) and OpenCode
  CLI workflows. Use after `opencode /init`, VS Code Copilot initialization, or migration to
  scaffold and check instructions, agents, skills, prompts, and hybrid folder hierarchies.
tools: Read, Grep, Glob, Edit, Write, Bash, WebFetch, WebSearch
---

<!-- Generated from harness/github-copilot/plugins/codebase-blueprints/agents/repo-architect.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
