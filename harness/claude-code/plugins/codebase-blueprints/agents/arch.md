...
name: arch
description: >-
  Creates comprehensive architecture documentation and Mermaid diagrams for cloud-native systems,
  NFRs, deployment, data flow, and phased designs. Use for architecture planning, not code
  generation.
tools: Read, Grep, Glob, Edit, Write, WebFetch, WebSearch
---

<!-- Generated from harness/github-copilot/plugins/codebase-blueprints/agents/arch.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
