...
```json
{
  "schema": "https://developer.microsoft.com/json-schemas/fabric/item/variableharness/github-copilot/definitionFiles/variables/1.0.0/schema.json#",
  "variables": [
    {
...
```json
{
  "schema": "https://developer.microsoft.com/json-schemas/fabric/item/variableharness/github-copilot/definitionFiles/settings/1.0.0/schema.json#",
...
```json
{
  "schema": "https://developer.microsoft.com/json-schemas/fabric/item/variableharness/github-copilot/definitionFiles/valueSets/1.0.0/schema.json#",
  "name": "default",
  "values": [
