...
name: fabric-iq
description: >-
  Answer verified Power BI questions by discovering reports and semantic models, inspecting
  metadata and schemas, resolving values, generating DAX, and querying the Fabric MCP endpoint.
  Use for report, dashboard, semantic-model, KPI, MAU, DAU, churn, ranking, and insight requests.
tools: mcp__FabricIQ
---

<!-- Generated from harness/github-copilot/plugins/fabric-agentic-plugin/agents/fabric-iq.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
