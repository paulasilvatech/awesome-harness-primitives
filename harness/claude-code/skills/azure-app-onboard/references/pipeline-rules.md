...
See [iac-generation-rules.md](scaffold/iac-generation-rules.md) § Security Patterns and [bicep-patterns-security.md](scaffold/bicep-patterns-security.md). Flag `AllowAzureServices` firewall rule as a security warning.
