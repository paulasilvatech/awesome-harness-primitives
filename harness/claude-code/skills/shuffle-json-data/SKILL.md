...
description: >-
  ...
  requiredProperties, ignoreProperties, and nesting rules before randomizing entries. Use when
  asked to shuffle, randomize, reorder, anonymize order, or vary repetitive JSON objects while
  keeping valid JSON and preserving data integrity.
---

<!-- Generated from harness/github-copilot/skills/shuffle-json-data/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
