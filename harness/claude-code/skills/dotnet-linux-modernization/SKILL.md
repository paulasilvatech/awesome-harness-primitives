...
description: >-
  ...
  System.Web to ASP.NET Core, planning incremental modernization, or moving .NET containers to
  Linux or ACA.
---

<!-- Generated from harness/github-copilot/skills/dotnet-linux-modernization/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
