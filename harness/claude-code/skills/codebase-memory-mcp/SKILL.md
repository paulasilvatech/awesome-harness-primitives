...
description: >-
  Use a configured Codebase Memory MCP graph for architecture orientation, symbol lookup, callers
  and callees, dependency or data-flow tracing, impact analysis, and unfamiliar module discovery.
  Use this skill when a codebase-memory-mcp server is available or the user explicitly requests
  Codebase Memory.
---

<!-- Generated from harness/github-copilot/skills/codebase-memory-mcp/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
