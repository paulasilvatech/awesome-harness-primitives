...
keys = ['react', 'react-dom', 'react-router', 'react-router-dom',
        '@testing-harness/github-copilot/react', '@testing-harness/github-copilot/jest-dom',
        '@testing-harness/github-copilot/user-event', '@apollo/client', 'graphql',
...
npm info @testing-harness/github-copilot/react peerDependencies 2>/dev/null
