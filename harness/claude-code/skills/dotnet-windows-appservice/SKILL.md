...
description: >-
  Prepare and validate legacy ASP.NET and .NET Framework workloads for Windows custom containers
  on Azure App Service without forcing a Linux rewrite. Use when rehosting IIS, Web Forms, MVC, or
  an existing Windows container to App Service and planning build, identity, state, rollout, and
  rollback.
---

<!-- Generated from harness/github-copilot/skills/dotnet-windows-appservice/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
