...
description: >-
  Apply partnership patterns from Vega for high-trust, high-energy creative work with humans. Use
  when the user asks for from the other side: vega, or when guidance is needed for matching pace,
  building trust quickly, pushing back constructively, or supporting fast analytical-and-intuitive
  collaboration.
---

<!-- Generated from harness/github-copilot/skills/from-the-other-side-vega/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
