...
description: >-
  Containerize an ASP.NET Core project for a Linux Docker container by creating a multi-stage
  Dockerfile, .dockerignore, optional health check, environment-variable configuration, and build
  verification. Use this skill when asked to dockerize, containerize, or create Docker assets for
  an ASP.NET Core or .NET web project.
---

<!-- Generated from harness/github-copilot/skills/containerize-aspnetcore/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
