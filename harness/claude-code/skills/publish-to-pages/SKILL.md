...
description: >-
  Publish presentations and web content to GitHub Pages by converting PPTX, PDF, HTML, or Google
  Slides into a deployable site, creating or updating a repository, enabling Pages, and returning
  the live URL. Use when the user asks to publish slides, deploy HTML, share a presentation,
  convert a deck to GitHub Pages, or create a public Pages link.
---

<!-- Generated from harness/github-copilot/skills/publish-to-pages/SKILL.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
