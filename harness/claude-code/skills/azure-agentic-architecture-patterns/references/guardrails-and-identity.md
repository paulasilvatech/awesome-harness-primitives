...
- **App registration.** For agents that call Microsoft Graph or protected APIs, register the app and request least-privilege scopes. Route to the `azure-entra-app-registration` skill.
