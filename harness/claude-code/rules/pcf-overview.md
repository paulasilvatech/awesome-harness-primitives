...
<!-- Generated from harness/github-copilot/instructions/pcf-overview.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Power Apps Component Framework overview conventions for capabilities, limitations, web-resource differences, APIs, licensing, and packaging. Use when building or documenting PCF code components.
