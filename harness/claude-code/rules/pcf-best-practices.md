---
paths:
  - "**/*.{ts,tsx,js,json,xml,pcfproj,csproj,css,html}"
---

<!-- Generated from harness/github-copilot/instructions/pcf-best-practices.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Power Apps Component Framework conventions for lifecycle, hosts, WebAPI use, bundling, React, Fluent UI, accessibility, styling, and ALM.
