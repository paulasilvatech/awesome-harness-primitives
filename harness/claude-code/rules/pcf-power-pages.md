...
<!-- Generated from harness/github-copilot/instructions/pcf-power-pages.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Power Pages conventions for using PCF code components, supported field types, unsupported APIs, model-driven field setup, form metadata, and portal Web API usage.
