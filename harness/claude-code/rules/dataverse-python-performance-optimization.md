...
<!-- Generated from harness/github-copilot/instructions/dataverse-python-performance-optimization.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces performance conventions for Python Dataverse SDK queries, pagination, batching, client reuse, file uploads, OData and SQL alternatives, memory management, retries, consistency checks, and monitoring.
