...
<!-- Generated from harness/github-copilot/instructions/terraform-sap-btp.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Terraform conventions for SAP Business Technology Platform infrastructure, including SAP BTP provider usage, security, state, validation, testing, and tool integration.
