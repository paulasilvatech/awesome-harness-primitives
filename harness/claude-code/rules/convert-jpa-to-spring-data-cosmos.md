...
<!-- Generated from harness/github-copilot/instructions/convert-jpa-to-spring-data-cosmos.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces conventions for converting Spring Boot JPA applications to Azure Cosmos DB with Spring Data Cosmos, including dependencies, configuration, entity mapping, repositories, services, tests, templates, and runtime validation.
