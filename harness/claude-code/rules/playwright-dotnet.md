...
<!-- Generated from harness/github-copilot/instructions/playwright-dotnet.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Playwright .NET test conventions for locators, assertions, structure, fixtures, accessibility snapshots, and execution. Use when writing C# end-to-end tests with Playwright.
