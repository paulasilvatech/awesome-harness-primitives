<!-- Generated from harness/github-copilot/instructions/exclude-prompt-data.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Prevents prompt instructions, rationale, meta-commentary, scaffold labels, and local personal data from leaking into generated documentation, comments, or code.
