...
<!-- Generated from harness/github-copilot/instructions/joyride-workspace-automation.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Joyride workspace automation conventions for REPL-driven ClojureScript, VS Code API usage, workspace activation, data-oriented design, and safe file updates.
