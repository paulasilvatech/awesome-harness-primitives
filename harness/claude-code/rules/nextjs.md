...
<!-- Generated from harness/github-copilot/instructions/nextjs.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Next.js App Router conventions for Next.js 16.1.1, Server and Client Components, async request APIs, Route Handlers, Cache Components, tooling, structure, security, and testing.
