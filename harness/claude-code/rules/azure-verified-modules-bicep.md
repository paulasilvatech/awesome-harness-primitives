...
<!-- Generated from harness/github-copilot/instructions/azure-verified-modules-bicep.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Azure Verified Modules Bicep discovery, registry references, version pinning, symbolic names, parameters, security, builds, and PR readiness.
