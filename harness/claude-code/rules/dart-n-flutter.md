...
<!-- Generated from harness/github-copilot/instructions/dart-n-flutter.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Dart language style, Effective Dart usage, and Flutter architecture conventions for Dart and Flutter code.
