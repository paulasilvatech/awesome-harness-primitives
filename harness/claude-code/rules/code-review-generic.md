<!-- Generated from harness/github-copilot/instructions/code-review-generic.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces generic GitHub Copilot code-review conventions for severity, comment format, and cross-cutting checks across reviewable files.
