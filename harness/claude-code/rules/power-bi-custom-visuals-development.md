---
paths:
  - "**/*.{ts,tsx,js,jsx,json,less,css}"
---

<!-- Generated from harness/github-copilot/instructions/power-bi-custom-visuals-development.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Power BI custom visual conventions for pbiviz projects, TypeScript, React, D3, formatting models, interactivity, testing, performance, and packaging.
