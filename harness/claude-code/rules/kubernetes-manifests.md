...
<!-- Generated from harness/github-copilot/instructions/kubernetes-manifests.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Kubernetes manifest conventions for labels, annotations, security contexts, pod security, resources, probes, rollout strategy, HA, validation, and secrets.
