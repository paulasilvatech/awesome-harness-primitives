...
<!-- Generated from harness/github-copilot/instructions/kubernetes-deployment-best-practices.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Kubernetes manifest conventions for Pods, Deployments, Services, Ingress, configuration, health checks, resources, scaling, security, observability, rollout strategy, and troubleshooting.
