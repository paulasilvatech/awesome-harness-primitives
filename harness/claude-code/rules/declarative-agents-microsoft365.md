...
<!-- Generated from harness/github-copilot/instructions/declarative-agents-microsoft365.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Microsoft 365 Copilot declarative agent conventions for schema v1.5 manifests, TypeSpec models, capabilities, toolkit workflows, testing, deployment, monitoring, and security.
