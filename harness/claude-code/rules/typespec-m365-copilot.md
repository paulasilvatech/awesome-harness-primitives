...
<!-- Generated from harness/github-copilot/instructions/typespec-m365-copilot.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces TypeSpec conventions for Microsoft 365 Copilot declarative agents, capabilities, API plugins, authentication, cards, validation, and security.
