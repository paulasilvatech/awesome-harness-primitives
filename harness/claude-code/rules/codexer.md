...
<!-- Generated from harness/github-copilot/instructions/codexer.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Codexer Python research and implementation conventions for Python files, dependency hygiene, code quality, testing, security, and research-backed decisions.
