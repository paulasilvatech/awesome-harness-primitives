<!-- Generated from harness/github-copilot/instructions/spec-driven-workflow-v1.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Specification-Driven Workflow v1 conventions for requirements, design, tasks, documentation, validation, reflection, handoff, troubleshooting, debt, quality metrics, and EARS notation.
