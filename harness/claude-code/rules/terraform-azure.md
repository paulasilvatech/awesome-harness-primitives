...
<!-- Generated from harness/github-copilot/instructions/terraform-azure.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Azure Terraform conventions for AVM usage, file layout, variables, secrets, state, providers, validation, documentation, cost, and operations.
