...
<!-- Generated from harness/github-copilot/instructions/markdown-content-creation.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Markdown content creation conventions for blog post structure, YAML front matter, headings, lists, code blocks, links, images, tables, line length, and validation.
