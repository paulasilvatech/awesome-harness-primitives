---
paths:
  - "**/*.{ts,tsx,js,json,xml,pcfproj,csproj,sln}"
---

<!-- Generated from harness/github-copilot/instructions/pcf-alm.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Power Apps component framework ALM conventions for PCF projects, cdsproj solutions, builds, source control, SolutionPackager, versioning, deployment, pipelines, and canvas apps.
