...
<!-- Generated from harness/github-copilot/instructions/copilot-sdk-java.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Java conventions for applications using the GitHub Copilot SDK, including client setup, virtual threads, sessions, permissions, events, tools, BYOK, MCP servers, and cleanup.
...
var session = client.createSession(new SessionConfig()
    .setProvider(new ProviderConfig()
        ...
        .setAzure(new AzureOptions()
            .setEndpoint("https://<your-resource-name>.openai.azure.com")
            .setDeployment("gpt-4"))
        .setBearerToken("..."))
    .setOnPermissionRequest(PermissionHandler.APPROVE_ALL)
).get();
