...
<!-- Generated from harness/github-copilot/instructions/dotnet-framework.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces .NET Framework conventions for MSBuild, legacy and SDK-style project files, C# 7.3 compatibility, NuGet boundaries, Windows paths, async, configuration, exceptions, disposal, and performance.
