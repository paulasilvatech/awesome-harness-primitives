...
<!-- Generated from harness/github-copilot/instructions/oop-design-patterns.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces object-oriented design pattern and SOLID conventions for clean, maintainable, and scalable code. Use when generating or refactoring OOP code in Python, Java, TypeScript, JavaScript, or C#.
