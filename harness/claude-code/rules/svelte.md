...
<!-- Generated from harness/github-copilot/instructions/svelte.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces Svelte 5 and SvelteKit 2 conventions for runes reactivity, routing, load functions, form actions, remote functions, TypeScript, styling, performance, errors, security, and accessibility.
