...
<!-- Generated from harness/github-copilot/instructions/update-docs-on-code-change.instructions.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

> **Scope.** Enforces documentation synchronization when code changes affect README files, API docs, configuration guides, changelogs, examples, or migration guidance.
