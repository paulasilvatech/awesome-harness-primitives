---
description: >-
  Design a production agentic system on GitHub and Azure AI Foundry with architecture
  documentation and diagrams.
argument-hint: the system to design, for example an agentic RAG service on Foundry with a Redis semantic cache
---

<!-- Generated from harness/github-copilot/prompts/design-agentic-system.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
