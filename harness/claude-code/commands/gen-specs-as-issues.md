---
description: >-
  Identify missing product features and generate prioritized issue-ready implementation
  specifications.
argument-hint: "scope=<repository-or-area> create_issues=<yes|no>"
---

<!-- Generated from harness/github-copilot/prompts/gen-specs-as-issues.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
