---
description: >-
  Review PostgreSQL code for database-specific correctness, security, maintainability, and
  performance risks.
argument-hint: "target=<selection-or-project-area>"
allowed-tools: Read, Grep, Glob, Edit, Write
---

<!-- Generated from harness/github-copilot/prompts/postgresql-code-review.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
