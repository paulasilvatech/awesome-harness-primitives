...
<!-- Generated from harness/github-copilot/prompts/new-skill.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->

# /new-skill

## Objective

Scaffold a new GitHub Copilot Agent Skill under `harness/github-copilot/skills/` by routing the authoring workflow through the `skill-creator` skill and aligning the result with the current `skill.template.md` structure, validation expectations, progressive-disclosure model, and description quality bar.
...
- Edits under `harness/github-copilot/skills/<name>/` are permitted.
...
- Create `harness/github-copilot/skills/<name>/SKILL.md` with valid frontmatter on line 1 and a folder name that equals `name`.
...
### Skill Path
- `harness/github-copilot/skills/<name>/SKILL.md`
...
- [ ] `harness/github-copilot/skills/<name>/SKILL.md` exists and frontmatter parses from line 1.
...
**Step 3 — Create the skill location and frontmatter.** Create `harness/github-copilot/skills/<name>/SKILL.md` with frontmatter on line 1:
