---
description: >-
  Guide creation of a production-ready VS Code prompt file with valid frontmatter, structure, and
  validation criteria.
argument-hint: "name=<kebab-name> purpose=<goal> destination=<response|edit|path>"
allowed-tools: Read, Grep, Glob, Edit, Write
---

<!-- Generated from harness/github-copilot/prompts/prompt-builder.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
...
Use this prompt when a maintainer wants to design or generate a new VS Code prompt file and needs structured discovery before writing `harness/github-copilot/prompts/<name>.prompt.md` or another approved prompt destination.
