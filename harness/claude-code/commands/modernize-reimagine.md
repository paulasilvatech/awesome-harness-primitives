---
description: >-
  Design a target modernization architecture that preserves required behavior and names
  intentional changes.
argument-hint: legacy system, rules artifact, map artifact, or target stack
---

<!-- Generated from harness/github-copilot/prompts/modernize-reimagine.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
