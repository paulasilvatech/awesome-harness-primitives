---
description: >-
  Harden a modernized module or system with ranked security, testing, observability, and
  operations findings.
argument-hint: modernized folder or module
---

<!-- Generated from harness/github-copilot/prompts/modernize-harden.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
