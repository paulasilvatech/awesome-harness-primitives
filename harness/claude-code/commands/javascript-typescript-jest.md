---
description: >-
  Guide JavaScript and TypeScript Jest testing with structure, mocking, async, snapshot, React
  component, and matcher practices.
---

<!-- Generated from harness/github-copilot/prompts/javascript-typescript-jest.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
