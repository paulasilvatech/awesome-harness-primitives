---
description: >-
  Analyze a project and generate a technology-agnostic folder structure blueprint with naming and
  placement conventions.
---

<!-- Generated from harness/github-copilot/prompts/folder-structure-blueprint-generator.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
