---
description: >-
  Refactor a Python script into a beginner-friendly project with instructional comments and a
  tutorial.
---

<!-- Generated from harness/github-copilot/prompts/comment-code-generate-a-tutorial.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
