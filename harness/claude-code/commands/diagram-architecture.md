---
description: >-
  Produce an editable draw.io architecture diagram and exported SVG using official Azure,
  Microsoft, and GitHub icons.
argument-hint: what to diagram, for example an agentic platform on Foundry with Redis, APIM, and API Center
---

<!-- Generated from harness/github-copilot/prompts/diagram-architecture.prompt.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
