...
name: context7
description: >-
  Documentation-first library and framework expert that uses Context7 and version checks before
  answering API, syntax, best-practice, migration, or code-generation questions. Use when current
  package documentation matters.
tools: Read, Grep, Glob, WebFetch, WebSearch, Agent, mcp__context7
mcpServers:
  context7:
    type: http
...
<!-- Generated from harness/github-copilot/agents/context7.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
