---
name: dotnet-modernization-assessor
description: >-
  Assess legacy .NET workloads and distinguish Windows App Service rehosting from modern .NET
  Linux migration. Use when choosing a migration path for IIS, ASP.NET Framework, Web Forms,
  Windows containers, App Service, or Azure Container Apps.
tools: Read, Grep, Glob, WebFetch
---

<!-- Generated from harness/github-copilot/agents/dotnet-modernization-assessor.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
