...
description: >-
  ...
  Spark-native rewrites and safer distributed patterns (incl. mapInPandas guidance). Use when
  PySpark code may not scale or may not be truly distributed.
tools: Read, Grep, Glob, Edit, Write
---

<!-- Generated from harness/github-copilot/agents/spark-performance.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
