...
description: >-
  Builds verified Python notebooks that demonstrate Azure and AI features. Use when creating
  hands-on VS Code notebook samples.
tools: Read, Grep, Glob, Edit, Write, Bash, WebFetch, WebSearch, Agent, mcp__mslearnmcp
---

<!-- Generated from harness/github-copilot/agents/python-notebook-sample-builder.agent.md by harness/claude-code/scripts/convert_from_copilot.py. Edit the source, not this file. -->
