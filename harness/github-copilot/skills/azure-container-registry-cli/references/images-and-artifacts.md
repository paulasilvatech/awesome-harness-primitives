...
az acr import --name {registry} --source docker.io/harness/github-copilot/nginx:1.27 --image nginx:1.27
...
az acr import --name {registry} --source docker.io/harness/github-copilot/nginx:1.27 --image nginx:1.27 --force
```
...
# Cache rule: docker.io/harness/github-copilot/* -> {registry}.azurecr.io/dockerhub/*
az acr cache create --registry {registry} --name dockerhub-cache \
  --source-repo "docker.io/harness/github-copilot/*" --target-repo "dockerhub/*" \
