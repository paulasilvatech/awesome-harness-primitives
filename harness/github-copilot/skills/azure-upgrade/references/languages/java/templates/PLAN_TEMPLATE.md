...
<!--
  ...
  | com.microsoft.azure:azure-client-authentication | 1.7.14 | com.azure:azure-identity             | Use DefaultAzureCredential with managed identity or workload identity |
...
<!--
  ...
  - **Authentication Migration**
    ...
    - **Strategy**: Replace file-based credentials with DefaultAzureCredential and use managed identity or workload identity in hosted environments.
  - **Fluent API Changes**
