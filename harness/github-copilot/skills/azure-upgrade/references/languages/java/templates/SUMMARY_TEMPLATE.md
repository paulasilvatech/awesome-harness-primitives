...
<!--
  ...
  - **Authentication Migration**
    ...
    - **Resolution**: Replaced file-based credentials with DefaultAzureCredential and managed identity or workload identity.
...
<!--
  ...
  **Necessity**: ⚠️ Behavior changes required by SDK migration (documented below)
  ...
  | ------------------ | ------------------------------------------------ | ---------------------------------------------- | --------------------- |
  | Authentication     | Azure.authenticate() → DefaultAzureCredential    | Legacy auth API removed in modern SDK           | Managed identity or workload identity |
-->
