...
|--------|:---:|:---:|:---:|:---:|
| Contents API + `github.com/raw/` | Yes | Do | Do Not | Yes |
| Browser drag-drop (`user-attachments`) | Yes | Yes | Do | Do Not |
| `raw.githubusercontent.com` | (404) | Do | Do Not | Yes |
| Gist | Public only | Yes | Yes | (no binary) |
