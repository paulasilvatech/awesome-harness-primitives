...
description: >-
  Inventory legacy .NET projects, identify Windows and app-model migration risks, and check container
  platform evidence before choosing Azure hosting. Use when assessing .NET Framework, IIS, Web Forms,
  Windows containers, Windows-to-Linux migration, App Service readiness, or Azure Container Apps readiness.
---
