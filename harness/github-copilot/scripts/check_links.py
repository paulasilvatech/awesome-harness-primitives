...
Usage:
  python3 harness/github-copilot/scripts/check_links.py                    # check everything
  python3 harness/github-copilot/scripts/check_links.py --path harness/github-copilot/skills  # limit to a subtree
  python3 harness/github-copilot/scripts/check_links.py --json report.json # machine-readable output
  python3 harness/github-copilot/scripts/check_links.py --cache .linkcache.json
  python3 harness/github-copilot/scripts/check_links.py --only-problems    # hide OK rows
