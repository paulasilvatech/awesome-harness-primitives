---
description: "Implement one approved SIFAP modernization slice with behavior-pinning tests and traceable validation. Use after requirements and architecture are approved for Java, Next.js, PostgreSQL, or integration work."
...
Before editing, load `sifap-modernization-context`, `sifap-loop`, `sifap-requirements-traceability`,
