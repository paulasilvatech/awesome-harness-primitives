...
agent: 'sifap-classic-evolution'
---

# /sifap-classic-evolve
...
```text
/sifap-classic-evolve scope=impl/001-payment-inspection destination=04-evolution/reviews/001-payment-inspection.md
```
...
| --- | --- | --- |
| `sifap-classic-evolution` | agent | Owns readiness judgment and approval boundaries. |
| `sifap-classic-orchestration` | skill | Evaluates the Stage 4 exit gate and final handoff. |
