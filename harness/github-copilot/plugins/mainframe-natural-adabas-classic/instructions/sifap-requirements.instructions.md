---
description: "Requires SIFAP EARS requirements to use REQ-NNN, valid source_legacy evidence, Given/When/Then acceptance criteria, and test lineage. Use when editing specifications or requirement artifacts."
applyTo: "specs/**/*.md,02-modern-spec/**/*.md,01-archaeology/**/*rules*.md"
---
