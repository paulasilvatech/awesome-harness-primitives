...
| Event Hubs | — | — |
| **Integration** | | |
| API Management | [APIM](apim.md) | `apim-ai-gateway` (invoke for AI Gateway policies) |
...
| **Security & Identity** | | |
| Key Vault | [Key Vault](services/key-vault/README.md) | `azure-compliance` |
| Managed Identity | — | `azure-entra-app-registration` |
| **Observability** | | |
...
| **AI Services** | | |
| Azure OpenAI | [Foundry](services/foundry/README.md) | `microsoft-agent-framework` (invoke for AI patterns and model guidance) |
...
| Building AI applications | `microsoft-agent-framework` |
...
1. Invoke: `microsoft-agent-framework` (AI patterns and best practices)
