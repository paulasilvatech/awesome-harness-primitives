---
description: "Implement one approved COBOL/DB2 modernization slice with behavior-pinning tests and traceable validation. Use after requirements and target design are approved for application, data-access, or integration work."
...
Before editing, load `cobol-db2-context`, `cobol-db2-loop`, `legacy-characterization-testing`, and the
...
| --- | --- | --- | --- |
| `cobol-db2-architect` | agent | Requirements or design are ambiguous or drift needs approval | Evidence, affected REQ-ID, alternatives, and impact. |
| `cobol-db2-quality` | agent | The bounded implementation is validated | Changes, tests, drift classification, and in-scope tables and datasets. |
