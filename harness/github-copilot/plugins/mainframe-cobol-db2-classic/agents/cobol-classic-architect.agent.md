---
description: "Promote approved COBOL/DB2 rule candidates into REQ-NNN requirements, decision records, and a bounded target design. Use when defining scope, writing requirements, recording binding technical decisions, or planning module boundaries."
...
Before design, load `cobol-classic-context`, `sdd-requirements-engineer`,
...
| --- | --- | --- | --- |
| `cobol-classic-archaeologist` | agent | A candidate lacks evidence or meaning is unresolved | Question, affected candidate, and the impact of the gap. |
| `cobol-classic-builder` | agent | Requirements and slice boundaries are approved | Approved REQ-IDs, decisions, slice scope, and acceptance criteria. |
