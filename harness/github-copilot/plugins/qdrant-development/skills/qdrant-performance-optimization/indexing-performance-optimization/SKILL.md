...
- Understand the indexing optimizer [Indexing optimizer](https://qdrant.tech/documentation/operations/optimizer/?s=indexing-optimizer)
...
- Create more shards (3-12), each shard has an independent update worker [Sharding](https://qdrant.tech/documentation/operations/distributed_deployment/?s=sharding)
...
- Disable HNSW during bulk load (set `indexing_threshold_kb` very high, restore after) [Collection params](https://qdrant.tech/documentation/manage-data/collections/?s=update-collection-parameters)
...
- Check actual progress via optimizations endpoint (v1.17+) [Optimization monitoring](https://qdrant.tech/documentation/operations/optimizer/?s=optimization-monitoring)
...
- Reduce `ef_construct` (100-200 sufficient) [HNSW config](https://qdrant.tech/documentation/manage-data/collections/?s=indexing-vectors-in-hnsw)
- Keep `max_indexing_threads` proportional to CPU cores [Configuration](https://qdrant.tech/documentation/operations/configuration/)
- Use GPU for indexing [GPU indexing](https://qdrant.tech/documentation/operations/running-with-gpu/)
