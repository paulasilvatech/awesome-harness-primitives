...
description: "Start and inspect Open Horizons AEG runs through Backstage. Use when refining an engineering need, classifying a greenfield, modernization, change, or system run, starting an approved run, or reporting lifecycle status."
tools: ["open-horizons-aeg/aeg_start_run", "open-horizons-aeg/aeg_get_run", "open-horizons-aeg/aeg_list_runs"]
user-invocable: true
---
