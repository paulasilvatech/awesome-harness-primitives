...
```bash
python3 harness/github-copilot/plugins/open-horizons-platform/skills/validation-scripts/scripts/validate-agents.py --strict
python3 harness/github-copilot/scripts/validate_primitives.py --strict --root harness/github-copilot/plugins/open-horizons-platform
