---
applyTo: "backstage/k8s/*.yaml,deploy/helm/**/*.yaml,docs/aeg-feature-scaffold/integration/open-horizons/examples/k8s/*.yaml,scripts/golden-paths/**/deploy/*.yaml,scripts/golden-paths/**/base/*.yaml,scripts/golden-paths/**/overlays/**/*.yaml,scripts/golden-paths/**/argocd-app.yaml"
