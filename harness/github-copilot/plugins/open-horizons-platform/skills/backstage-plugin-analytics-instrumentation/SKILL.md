---
name: backstage-plugin-analytics-instrumentation
description: "Instrument Backstage frontend plugins with meaningful Analytics API events and tests while avoiding duplicate BUI navigation events or UI noise. Use when adding or reviewing captureEvent, AnalyticsContext, event taxonomy, noTrack overrides, or analytics behavior."
license: Apache-2.0
metadata:
...
- `references/upstream/SKILL.md`: detailed analytics API, event, testing, and migration guidance.
