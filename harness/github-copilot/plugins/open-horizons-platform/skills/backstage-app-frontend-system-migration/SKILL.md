---
name: backstage-app-frontend-system-migration
description: "Migrate a Backstage adopter app from the legacy frontend system to the new extension-based frontend system through hybrid and full-migration phases. Use when converting createApp, feature discovery, routes, sidebar, APIs, themes, or app-level frontend compatibility."
license: Apache-2.0
metadata:
...
- `references/upstream/SKILL.md`: upstream migration procedure retained for detailed compatibility guidance.
