---
description: "Apply Backstage sign-in, identity resolver, delegated access, service auth, and permission-boundary conventions. Use when editing auth configuration or provider modules."
applyTo: "app-config*.yaml,packages/app/**/*.{ts,tsx},packages/backend/**/*.{ts,tsx}"
---
