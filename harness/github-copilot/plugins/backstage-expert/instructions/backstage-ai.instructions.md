---
description: "Apply Backstage AI Catalog, Actions Registry, and MCP Actions conventions. Use when editing AiResource or mcp-server entities, backend actions, or MCP Actions configuration."
applyTo: "**/catalog-info.yaml,app-config*.yaml,packages/backend/**/*.{ts,tsx},plugins/**/*.{ts,tsx}"
---
