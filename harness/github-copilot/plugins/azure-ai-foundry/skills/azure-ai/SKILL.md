---
name: azure-ai
description: "Build on Azure AI services including AI Search, Speech, Azure OpenAI, and Document Intelligence, covering keyword, vector, hybrid, and semantic search, speech-to-text, text-to-speech, transcription, and OCR. Use when the user asks about AI Search, query search, vector search, hybrid search, semantic search, speech-to-text, text-to-speech, transcription, OCR, or converting text to speech."
license: MIT
metadata:
  author: Microsoft
  version: "1.2.1"
allowed-tools: "com.microsoft/azure/documentation com.microsoft/azure/foundry com.microsoft/azure/search"
---
