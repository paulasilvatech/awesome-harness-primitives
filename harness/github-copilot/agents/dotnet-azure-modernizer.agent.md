---
description: "Implement assessed .NET migrations to Windows containers on App Service or modern .NET Linux containers on App Service and Azure Container Apps. Use when preparing or executing an approved legacy .NET rehost, runtime upgrade, or Windows-to-Linux modernization."
---
