---
name: ".NET Upgrade"
description: "Performs evidence-driven .NET framework and SDK upgrades, package compatibility checks, CI updates, and validation. Use when migrating .NET projects to a selected supported stable or LTS version."
