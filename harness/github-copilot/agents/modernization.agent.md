---
description: >-
  Orchestrate evidence-driven legacy modernization from brief through assessment, rule extraction, mapping, target design, bounded transformation, and hardening. Use when a repository needs a coordinated behavior-preserving modernization workflow.
