...
description: "Enforces Power Apps component framework conventions for model-driven app code components, manifests, TypeScript implementation, packaging, versioning, and documentation."
name: "PCF Model-Driven Apps Conventions"
---
