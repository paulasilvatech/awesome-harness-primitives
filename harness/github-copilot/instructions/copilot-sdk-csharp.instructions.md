---
applyTo: "**/*.cs,**/*.csproj"
description: "Conventions for building C# applications with the GitHub Copilot SDK, including client setup, sessions, permissions, streaming, custom tools, BYOK providers, and error handling."
