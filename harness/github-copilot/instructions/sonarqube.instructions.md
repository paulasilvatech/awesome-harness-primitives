---
description: "Requires evidence-backed, read-only SonarQube Server and SonarQube Cloud lookups when work depends on projects, quality gates, issues, hotspots, measures, analyses, metrics, rules, branches, or pull requests."
applyTo: "**"
---
