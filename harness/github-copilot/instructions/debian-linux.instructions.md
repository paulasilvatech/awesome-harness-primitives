---
applyTo: "**"
description: "Enforces Debian-based Linux administration conventions for apt workflows, package sources, configuration files, services, security, validation, and rollback guidance."
name: "Debian Linux Administration Conventions"
---
