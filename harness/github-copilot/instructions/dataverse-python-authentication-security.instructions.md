---
applyTo: "**/*.py"
description: "Enforces authentication and security conventions for Python Dataverse SDK apps that use Azure Identity credentials, DataverseClient configuration, secure secret handling, tenant isolation, and Dataverse permissions."
---
