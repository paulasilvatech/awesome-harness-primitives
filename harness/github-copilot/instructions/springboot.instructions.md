---
applyTo: '**/*.java,**/*.kt'
description: 'Conventions for Spring Boot base applications covering dependency injection, configuration, package organization, services, logging, security, validation, builds, and useful Maven or Gradle commands.'
---
