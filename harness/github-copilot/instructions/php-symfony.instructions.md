...
description: "Enforces Symfony conventions for project structure, configuration, dependency injection, controllers, Doctrine, Twig, forms, validation, security, assets, Messenger, and testing."
---
