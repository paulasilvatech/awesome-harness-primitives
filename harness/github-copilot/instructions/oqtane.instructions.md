...
description: 'Conventions for Oqtane and Blazor modules covering component structure, client/server module patterns, services, controllers, repositories, validation, performance, caching, state, testing, and security.'
---
