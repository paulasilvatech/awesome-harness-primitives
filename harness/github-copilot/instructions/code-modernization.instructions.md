---
description: "Preserves legacy evidence, separates modernization analysis from implementation, and requires traceable behavior validation. Use when editing legacy, analysis, or modernized source zones."
