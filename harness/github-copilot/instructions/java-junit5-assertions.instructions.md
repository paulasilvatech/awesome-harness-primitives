...
description: "Enforces JUnit Jupiter assertion conventions for imports, expected/actual ordering, lazy messages, grouped assertions, exception checks, timeouts, type safety, and collection comparisons."
---
