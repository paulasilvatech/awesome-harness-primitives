...
description: "Enforces Azure Functions C# isolated worker conventions for host setup, triggers, bindings, dependency injection, configuration, retries, observability, performance, security, and testing."
---
