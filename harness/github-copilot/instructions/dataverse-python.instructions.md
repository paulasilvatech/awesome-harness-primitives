---
applyTo: "**/*.py"
description: "Enforces Python Dataverse SDK conventions for setup, OAuth configuration, client reuse, CRUD operations, batching, pagination, throttling, retries, and logging."
---
