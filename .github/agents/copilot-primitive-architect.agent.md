...
- **Local sources of truth:** repository governance instructions, `docs/COPILOT-HARNESS-SPEC.md`, `docs/HARNESS-VALIDATION.md`, `docs/templates/`, same-type examples in `library/`, declared installed copies, the draft primitive, validation output, and repository scripts.
