...
- **Every requirement includes a `source_legacy:` line** pointing to legacy files or `[GREENFIELD] + justification.`
  ...
  The traceability gate rejects PRs that violate this rule. See the [SIFAP traceability skill](../harness/github-copilot/plugins/mainframe-modernization/skills/sifap-requirements-traceability/SKILL.md).
...
- Branch strategy: one prefix per persona/stage, each cut from `develop` (never from `spec/*`) and merged back `develop` → `main`; there is no `stage` branch.
  ...
  - Full stage guidance: [workshop flow](../harness/github-copilot/plugins/mainframe-modernization/skills/sifap-modernization-context/references/workshop-flow.md)
...
- ❌ Do not assume a pre-existing application prototype, containerization, or infrastructure tree. Inspect the target and follow the [source layout contract](../harness/github-copilot/plugins/mainframe-modernization/skills/sifap-modernization-context/references/source-layout.md).
...
- ❌ Do not skip evidence-gated stage handoffs; follow the [workshop flow](../harness/github-copilot/plugins/mainframe-modernization/skills/sifap-modernization-context/references/workshop-flow.md).
...
- ❌ Do not add or edit a Copilot primitive outside the [harness contract](../docs/COPILOT-HARNESS-SPEC.md) and canonical plugin.

## References

- Workshop flow: [workshop-flow.md](../harness/github-copilot/plugins/mainframe-modernization/skills/sifap-modernization-context/references/workshop-flow.md)
- SIFAP source layout: [source-layout.md](../harness/github-copilot/plugins/mainframe-modernization/skills/sifap-modernization-context/references/source-layout.md)
- Stage agents and capabilities: [canonical plugin README](../harness/github-copilot/plugins/mainframe-modernization/README.md)
- Primitive governance: [COPILOT-HARNESS-SPEC.md](../docs/COPILOT-HARNESS-SPEC.md)
- Runtime evidence: [HARNESS-VALIDATION.md](../docs/HARNESS-VALIDATION.md)
