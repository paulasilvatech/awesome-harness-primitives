...
| --- | --- | --- |
| WCAG and ARIA | [WCAG 2.2](https://www.w3.org/TR/WCAG22/) and [ARIA APG](https://www.w3.org/WAI/ARIA/apg/) | The official URLs were identified, but this fetch client received HTTP `403` from the W3C pages. Existing repository WCAG 2.2 AA guidance was not given a new verification date; implementation must repeat this check through an approved first-party access path. |
