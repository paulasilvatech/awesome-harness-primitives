...
- With scalar quantization: divide by 4 (INT8 reduces each float32 to 1 byte) [Quantization](https://qdrant.tech/documentation/manage-data/quantization/)
- With binary quantization: divide by 32 [Binary quantization](https://qdrant.tech/documentation/manage-data/quantization/?s=binary-quantization)
