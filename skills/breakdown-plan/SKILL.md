...
name: "breakdown-plan"
description: >-
  Issue Planning and Automation prompt that generates comprehensive project plans with Epic > Feature
  > Story/Enabler > Test hierarchy, dependencies, priorities, and automated tracking. Use this skill
  when the user asks for github issue planning & project automation prompt.
---
...
For the sprint goal markdown template, project board configuration, automation snippets, and issue-creation checklist, read [Sprint planning template details](references/sprint-planning-template.md).

## Bundled Resources

- [Sprint planning template details](references/sprint-planning-template.md) — When producing sprint-by-sprint output, open this template section to preserve the detailed sprint format.
