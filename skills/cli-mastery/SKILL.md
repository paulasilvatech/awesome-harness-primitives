...
name: "cli-mastery"
description: >-
  Interactive training for the GitHub Copilot CLI. Guided lessons, quizzes, scenario challenges, and a
  full reference covering slash commands, shortcuts, modes, agents, skills, MCP, and configuration.
  Say "cliexpert" to start. Use this skill when |---------|--------|; | "cliexpert", "teach me" | Read
  next `references/module-N-*.md`, teach |; | "quiz me", "test me" | Read current module, 5+ questions
  via `ask_user` |.
metadata:
  version: "1.2.0"
license: "MIT"
