...
description: >-
  Terraform-focused agent that reviews and creates safer IaC changes with emphasis on state safety, least privilege, module patterns, drift detection, and plan/apply discipline. Use for Terraform review or bounded IaC edits.
