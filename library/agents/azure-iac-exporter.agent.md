...
description: >-
  Export existing Azure resources to Infrastructure as Code templates through Azure Resource Graph, Azure Resource Manager API analysis, data-plane inspection, and IaC generation. Use when the user wants Bicep, ARM Template, Terraform, or Pulumi from existing Azure resources.
