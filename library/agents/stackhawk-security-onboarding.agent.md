...
description: "Sets up StackHawk API security testing when a repository exposes a web app or API attack surface."
...
```markdown
Based on my analysis, this repository appears to be <library/documentation/configuration> rather than a deployed application or API. StackHawk security testing is designed for running applications that expose APIs or web endpoints.
...
- [ ] The repository was classified as application/API, library/package, documentation/config, or uncertain with evidence.
