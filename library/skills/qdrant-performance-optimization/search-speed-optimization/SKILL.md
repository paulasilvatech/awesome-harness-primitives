...
- Tune HNSW parameters: [Fine-tuning search](https://qdrant.tech/documentation/operations/optimize/?s=fine-tuning-search-parameters)
...
- Reduce Vector Dimensionality with Matryoshka Models: [Matryoshka Models](https://qdrant.tech/documentation/inference/?s=reduce-vector-dimensionality-with-matryoshka-models)
...
- Reduce segment count (`default_segment_number` to 2) [Maximizing throughput](https://qdrant.tech/documentation/operations/optimize/?s=maximizing-throughput)
...
- Add replicas to distribute read load [Replication](https://qdrant.tech/documentation/operations/distributed_deployment/?s=replication)
