...
description: >-
  Select the least-privilege Azure role for an identity, explain matching built-in or custom role
  options, and provide assignment commands or Bicep snippets. Use this skill when the user asks
  which Azure RBAC role to assign for specific permissions, scopes, identities, or access
  requirements.
