...
- Run `python library/skills/code-tour/scripts/validate_tour.py .tours/<name>.tour --repo-root .` after writing a tour in this repository. In installed skill locations, the same script may be under `~/.agents/skills/code-tour/scripts/validate_tour.py`.
...
```bash
python library/skills/code-tour/scripts/generate_from_docs.py --persona new-joiner --output .tours/skeleton.tour
python library/skills/code-tour/scripts/validate_tour.py .tours/<name>.tour --repo-root .
...
### Validation
- `python library/skills/code-tour/scripts/validate_tour.py .tours/<name>.tour --repo-root .`: pass | fail
