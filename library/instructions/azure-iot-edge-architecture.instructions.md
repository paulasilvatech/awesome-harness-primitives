...
description: "Enforces Azure IoT Edge architecture conventions for documentation-grounded edge applicability, runtime constraints, supported systems, operations, security, and assumptions."
---
