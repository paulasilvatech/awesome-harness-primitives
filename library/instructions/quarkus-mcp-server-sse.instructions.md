---
applyTo: "*"
description: "Enforces Java 21 Quarkus MCP server conventions for HTTP SSE transport, CDI tools, layered architecture, validation, and error handling."
name: "Quarkus MCP Server SSE Conventions"
---
