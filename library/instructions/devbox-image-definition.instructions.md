---
applyTo: "**/*.yaml,**/*.yml"
description: "Enforces Microsoft Dev Box Team Customizations image definition conventions for task discovery, intrinsic task syntax, secrets, context placement, validation, and troubleshooting."
---
