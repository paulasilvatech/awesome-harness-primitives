---
applyTo: '**/*.py'
description: 'Enforces Python Dataverse SDK API usage conventions for DataverseClient methods, DataverseConfig, DataverseError handling, OData options, and metadata operations.'
---
